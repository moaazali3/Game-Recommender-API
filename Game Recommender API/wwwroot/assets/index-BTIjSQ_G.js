...
Please change the parent <Route path="${e}"> to <Route path="${e===`/`?`*`:`${e}/*`}">.`)}let u=_t(),d;if(t){let e=typeof t==`string`?se(t):t;T(c===`/`||e.pathname?.startsWith(c),`When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${c}" but pathname "${e.pathname}" was given in the \`location\` prop.`),d=e}else d=u;let f=d.pathname||`/`,p=f;if(c!==`/`){let e=c.replace(/^\//,``).split(`/`);p=`/`+f.replace(/^\//,``).split(`/`).slice(e.length).join(`/`)}let m=n&&n.state.matches.length?n.state.matches.map(e=>Object.assign(e,{route:n.manifest[e.route.id]||e.route})):O(e,{pathname:p});E(l||m!=null,`No routes matched location "${d.pathname}${d.search}${d.hash}" `),E(m==null||m[m.length-1].route.element!==void 0||m[m.length-1].route.Component!==void 0||m[m.length-1].route.lazy!==void 0,`Matched leaf route at location "${d.pathname}${d.search}${d.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);let h=At(m&&m.map(e=>Object.assign({},e,{params:Object.assign({},o,e.params),pathname:Pe([c,r.encodeLocation?r.encodeLocation(e.pathname.replace(/%/g,`%25`).replace(/\?/g,`%3F`).replace(/#/g,`%23`)).pathname:e.pathname]),pathnameBase:e.pathnameBase===`/`?c:Pe([c,r.encodeLocation?r.encodeLocation(e.pathnameBase.replace(/%/g,`%25`).replace(/\?/g,`%3F`).replace(/#/g,`%23`)).pathname:e.pathnameBase])})),i,n);return t&&h?x.createElement(st.Provider,{value:{location:{pathname:`/`,search:``,hash:``,state:null,key:`default`,mask:void 0,...d},navigationType:`POP`}},h):h}function Tt(){let e=Lt(),t=Be(e)?`${e.status} ${e.statusText}`:e instanceof Error?e.message:JSON.stringify(e),n=e instanceof Error?e.stack:null,r=`rgba(200,200,200, 0.5)`,i={padding:`0.5rem`,backgroundColor:r},a={padding:`2px 4px`,backgroundColor:r},o=null;return console.error(`Error handled by React Router default ErrorBoundary:`,e),o=x.createElement(x.Fragment,null,x.createElement(`p`,null,`💿 Hey developer 👋`),x.createElement(`p`,null,`You can provide a way better UX than this when your app throws errors by providing your own `,x.createElement(`code`,{style:a},`ErrorBoundary`),` or`,` `,x.createElement(`code`,{style:a},`errorElement`),` prop on your route.`)),x.createElement(x.Fragment,null,x.createElement(`h2`,null,`Unexpected Application Error!`),x.createElement(`h3`,{style:{fontStyle:`italic`}},t),n?x.createElement(`pre`,{style:i},n):null,o)}var Et=x.createElement(Tt,null),j=class extends x.Component{constructor(e){super(e),this.state={location:e.location,revalidation:e.revalidation,error:e.error}}static getDerivedStateFromError(e){return{error:e}}static getDerivedStateFromProps(e,t){return t.location!==e.location||t.revalidation!==`idle`&&e.revalidation===`idle`?{error:e.error,location:e.location,revalidation:e.revalidation}:{error:e.error===void 0?t.error:e.error,location:t.location,revalidation:e.revalidation||t.revalidation}}componentDidCatch(e,t){this.props.onError?this.props.onError(e,t):console.error(`React Router caught the following error during render`,e)}render(){let e=this.state.error;if(this.context&&typeof e==`object`&&e&&`digest`in e&&typeof e.digest==`string`){let t=mt(e.digest);t&&(e=t)}let t=e===void 0?this.props.children:x.createElement(ct.Provider,{value:this.props.routeContext},x.createElement(lt.Provider,{value:e,children:this.props.component}));return this.context?x.createElement(Ot,{error:e},t):t}};j.contextType=tt;var Dt=new WeakMap;function Ot({children:e,error:t}){let{basename:n,navigator:r}=x.useContext(ot);if(typeof t==`object`&&t&&`digest`in t&&typeof t.digest==`string`){let e=pt(t.digest);if(e){let i=Dt.get(t);if(i)throw i;let a=Ue(e.location,n),o=a.absoluteURL||a.to;if(Je(e.location,o,Ge(r),`allow-explicit`),Qe(o))throw Error(`Invalid redirect location`);if(He&&!Dt.get(t)){if(a.isExternal||e.reloadDocument)window.location.href=o;else{let n=Promise.resolve().then(()=>window.__reactRouterDataRouter.navigate(a.to,{replace:e.replace}));throw Dt.set(t,n),n}}return x.createElement(`meta`,{httpEquiv:`refresh`,content:`0;url=${o}`})}}return e}function kt({routeContext:e,match:t,children:n}){let r=x.useContext($e);return r&&r.static&&r.staticContext&&(t.route.errorElement||t.route.ErrorBoundary)&&(r.staticContext._deepestRenderedBoundaryId=t.route.id),x.createElement(ct.Provider,{value:e},n)}function At(e,t=[],n){let r=n?.state;if(e==null){if(!r)return null;if(r.errors)e=r.matches;else if(t.length===0&&!r.initialized&&r.matches.length>0)e=r.matches;else return null}let i=e,a=r?.errors;if(a!=null){let e=i.findIndex(e=>e.route.id&&a?.[e.route.id]!==void 0);T(e>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(a).join(`,`)}`),i=i.slice(0,Math.min(i.length,e+1))}let o=!1,s=-1;if(n&&r){o=r.renderFallback;for(let e=0;e<i.length;e++){let t=i[e];if((t.route.HydrateFallback||t.route.hydrateFallbackElement)&&(s=e),t.route.id){let{loaderData:e,errors:a}=r,c=t.route.loader&&!e.hasOwnProperty(t.route.id)&&(!a||a[t.route.id]===void 0);if(t.route.lazy||c){n.isStatic&&(o=!0),i=s>=0?i.slice(0,s+1):[i[0]];break}}}}let c=n?.onError,l=r&&c?(e,t)=>{c(e,{location:r.location,params:r.matches?.[0]?.params??{},pattern:Ve(r.matches),errorInfo:t})}:void 0;return i.reduceRight((e,n,c)=>{let u,d=!1,f=null,p=null;r&&(u=a&&n.route.id?a[n.route.id]:void 0,f=n.route.errorElement||Et,o&&(s<0&&c===0?(Bt(`route-fallback`,!1,"No `HydrateFallback` element provided to render during initial hydration"),d=!0,p=null):s===c&&(d=!0,p=n.route.hydrateFallbackElement||null)));let m=t.concat(i.slice(0,c+1)),h=()=>{let t;return t=u?f:d?p:n.route.Component?x.createElement(n.route.Component,null):n.route.element?n.route.element:e,x.createElement(kt,{match:n,routeContext:{outlet:e,matches:m,isDataRoute:r!=null},children:t})};return r&&(n.route.ErrorBoundary||n.route.errorElement||c===0)?x.createElement(j,{location:r.location,revalidation:r.revalidation,component:f,error:u,children:h(),routeContext:{outlet:null,matches:m,isDataRoute:!0},onError:l}):h()},null)}function jt(e){return`${e} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function Mt(e){let t=x.useContext($e);return T(t,jt(e)),t}function Nt(e){let t=x.useContext(et);return T(t,jt(e)),t}function Pt(e){let t=x.useContext(ct);return T(t,jt(e)),t}function Ft(e){let t=Pt(e),n=t.matches[t.matches.length-1];return T(n.route.id,`${e} can only be used on routes that contain a unique "id"`),n.route.id}function It(){return Ft(`useRouteId`)}function Lt(){let e=x.useContext(lt),t=Nt(`useRouteError`),n=Ft(`useRouteError`);return e===void 0?t.errors?.[n]:e}function Rt(){let{router:e}=Mt(`useNavigate`),t=Ft(`useNavigate`),n=x.useRef(!1);return yt(()=>{n.current=!0}),x.useCallback(async(r,i={})=>{E(n.current,vt),n.current&&(typeof r==`number`?await e.navigate(r):await e.navigate(r,{fromRouteId:t,...i}))},[e,t])}var zt={};function Bt(e,t,n){!t&&!zt[e]&&(zt[e]=!0,E(!1,n))}x.memo(Vt);function Vt({routes:e,manifest:t,future:n,state:r,isStatic:i,onError:a}){return wt(e,void 0,{manifest:t,state:r,isStatic:i,onError:a,future:n})}function Ht(e){T(!1,`A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.`)}function Ut({basename:e=`/`,children:t=null,location:n,navigationType:r=`POP`,navigator:i,static:a=!1,useTransitions:o}){T(!gt(),`You cannot render a <Router> inside another <Router>. You should never have more than one in your app.`);let s=e.replace(/^\/*/,`/`),c=x.useMemo(()=>({basename:s,navigator:i,static:a,useTransitions:o,future:{}}),[s,i,a,o]);typeof n==`string`&&(n=se(n));let{pathname:l=`/`,search:u=``,hash:d=``,state:f=null,key:p=`default`,mask:m}=n,h=x.useMemo(()=>{let e=Ee(l,s);return e==null?null:{location:{pathname:e,search:u,hash:d,state:f,key:p,mask:m},navigationType:r}},[s,l,u,d,f,p,r,m]);return E(h!=null,`<Router basename="${s}"> is not able to match the URL "${l}${u}${d}" because it does not start with the basename, so the <Router> won't render anything.`),h==null?null:x.createElement(ot.Provider,{value:c},x.createElement(st.Provider,{children:t,value:h}))}function Wt({children:e,location:t}){return Ct(Gt(e),t)}x.Component;function Gt(e,t=[]){let n=[];return x.Children.forEach(e,(e,r)=>{if(!x.isValidElement(e))return;let i=[...t,r];if(e.type===x.Fragment){n.push.apply(n,Gt(e.props.children,i));return}T(e.type===Ht,`[${typeof e.type==`string`?e.type:e.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),T(!e.props.index||!e.props.children,`An index route cannot have child routes.`);let a={id:e.props.id||i.join(`-`),caseSensitive:e.props.caseSensitive,element:e.props.element,Component:e.props.Component,index:e.props.index,path:e.props.path,middleware:e.props.middleware,loader:e.props.loader,action:e.props.action,hydrateFallbackElement:e.props.hydrateFallbackElement,HydrateFallback:e.props.HydrateFallback,errorElement:e.props.errorElement,ErrorBoundary:e.props.ErrorBoundary,hasErrorBoundary:e.props.hasErrorBoundary===!0||e.props.ErrorBoundary!=null||e.props.errorElement!=null,shouldRevalidate:e.props.shouldRevalidate,handle:e.props.handle,lazy:e.props.lazy};e.props.children&&(a.children=Gt(e.props.children,i)),n.push(a)}),n}var Kt=`get`,qt=`application/x-www-form-urlencoded`;function Jt(e){return typeof HTMLElement<`u`&&e instanceof HTMLElement}function Yt(e){return Jt(e)&&e.tagName.toLowerCase()===`button`}function Xt(e){return Jt(e)&&e.tagName.toLowerCase()===`form`}function Zt(e){return Jt(e)&&e.tagName.toLowerCase()===`input`}function Qt(e){return!!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)}function $t(e,t){return e.button===0&&(!t||t===`_self`)&&!Qt(e)}function en(e=``){return new URLSearchParams(typeof e==`string`||Array.isArray(e)||e instanceof URLSearchParams?e:Object.keys(e).reduce((t,n)=>{let r=e[n];return t.concat(Array.isArray(r)?r.map(e=>[n,e]):[[n,r]])},[]))}function tn(e,t){let n=en(e);return t&&t.forEach((e,r)=>{n.has(r)||t.getAll(r).forEach(e=>{n.append(r,e)})}),n}var nn=null;function rn(){if(nn===null)try{new FormData(document.createElement(`form`),0),nn=!1}catch{nn=!0}return nn}var an=new Set([`application/x-www-form-urlencoded`,`multipart/form-data`,`text/plain`]);function on(e){return e!=null&&!an.has(e)?(E(!1,`"${e}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${qt}"`),null):e}function sn(e,t){let n,r,i,a,o;if(Xt(e)){let o=e.getAttribute(`action`);r=o?Ee(o,t):null,n=e.getAttribute(`method`)||Kt,i=on(e.getAttribute(`enctype`))||qt,a=new FormData(e)}else if(Yt(e)||Zt(e)&&(e.type===`submit`||e.type===`image`)){let o=e.form;if(o==null)throw Error(`Cannot submit a <button> or <input type="submit"> without a <form>`);let s=e.getAttribute(`formaction`)||o.getAttribute(`action`);if(r=s?Ee(s,t):null,n=e.getAttribute(`formmethod`)||o.getAttribute(`method`)||Kt,i=on(e.getAttribute(`formenctype`))||on(o.getAttribute(`enctype`))||qt,a=new FormData(o,e),!rn()){let{name:t,type:n,value:r}=e;if(n===`image`){let e=t?`${t}.`:``;a.append(`${e}x`,`0`),a.append(`${e}y`,`0`)}else t&&a.append(t,r)}}else if(Jt(e))throw Error(`Cannot submit element that is not <form>, <button>, or <input type="submit|image">`);else n=Kt,r=null,i=qt,o=e;return a&&i===`text/plain`&&(o=a,a=void 0),{action:r,method:n.toLowerCase(),encType:i,formData:a,body:o}}Object.getOwnPropertyNames(Object.prototype).sort().join(`\0`);function cn(e,t){if(e===!1||e==null)throw Error(t)}function ln(e,t,n,r){let i=typeof e==`string`?new URL(e,typeof window>`u`?`server://singlefetch/`:window.location.origin):e;return i.pathname=n?i.pathname.endsWith(`/`)?`${i.pathname}_.${r}`:`${i.pathname}.${r}`:i.pathname===`/`?`_root.${r}`:t&&Ee(i.pathname,t)===`/`?`${Fe(t)}/_root.${r}`:`${Fe(i.pathname)}.${r}`,i}async function un(e,t){if(e.id in t)return t[e.id];try{let n=await b(()=>import(e.module),[]);return t[e.id]=n,n}catch(t){return console.error(`Error loading route module \`${e.module}\`, reloading page...`),console.error(t),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function dn(e){return e!=null&&typeof e.page==`string`}function fn(e){return e==null?!1:e.href==null?e.rel===`preload`&&typeof e.imageSrcSet==`string`&&typeof e.imageSizes==`string`:typeof e.rel==`string`&&typeof e.href==`string`}async function pn(e,t,n){return vn((await Promise.all(e.map(async e=>{let r=t.routes[e.route.id];if(r){let e=await un(r,n);return e.links?e.links():[]}return[]}))).flat(1).filter(fn).filter(e=>e.rel===`stylesheet`||e.rel===`preload`).map(e=>e.rel===`stylesheet`?{...e,rel:`prefetch`,as:`style`}:{...e,rel:`prefetch`}))}function mn(e,t,n,r,i,a){let o=(e,t)=>!n[t]||e.route.id!==n[t].route.id,s=(e,t)=>n[t].pathname!==e.pathname||n[t].route.path?.endsWith(`*`)&&n[t].params[`*`]!==e.params[`*`];return a===`assets`?t.filter((e,t)=>o(e,t)||s(e,t)):a===`data`?t.filter((t,a)=>{let c=r.routes[t.route.id];if(!c||!c.hasLoader)return!1;if(o(t,a)||s(t,a))return!0;if(t.route.shouldRevalidate){let r=t.route.shouldRevalidate({currentUrl:new URL(i.pathname+i.search+i.hash,window.origin),currentParams:n[0]?.params||{},nextUrl:new URL(e,window.origin),nextParams:t.params,defaultShouldRevalidate:!0});if(typeof r==`boolean`)return r}return!0}):[]}function hn(e,t,{includeHydrateFallback:n}={}){return gn(e.map(e=>{let r=t.routes[e.route.id];if(!r)return[];let i=[r.module];return r.clientActionModule&&(i=i.concat(r.clientActionModule)),r.clientLoaderModule&&(i=i.concat(r.clientLoaderModule)),n&&r.hydrateFallbackModule&&(i=i.concat(r.hydrateFallbackModule)),r.imports&&(i=i.concat(r.imports)),i}).flat(1))}function gn(e){return[...new Set(e)]}function _n(e){let t={},n=Object.keys(e).sort();for(let r of n)t[r]=e[r];return t}function vn(e,t){let n=new Set,r=new Set(t);return e.reduce((e,i)=>{if(t&&!dn(i)&&i.as===`script`&&i.href&&r.has(i.href))return e;let a=JSON.stringify(_n(i));return n.has(a)||(n.add(a),e.push({key:a,link:i})),e},[])}function yn(){let e=x.useContext($e);return cn(e,`You must render this element inside a <DataRouterContext.Provider> element`),e}function bn(){let e=x.useContext(et);return cn(e,`You must render this element inside a <DataRouterStateContext.Provider> element`),e}var xn=x.createContext(void 0);xn.displayName=`FrameworkContext`;function Sn(){let e=x.useContext(xn);return cn(e,`You must render this element inside a <HydratedRouter> element`),e}function Cn(e,t){let n=x.useContext(xn),[r,i]=x.useState(!1),[a,o]=x.useState(!1),{onFocus:s,onBlur:c,onMouseEnter:l,onMouseLeave:u,onTouchStart:d}=t,f=x.useRef(null);x.useEffect(()=>{if(e===`render`&&o(!0),e===`viewport`){let e=new IntersectionObserver(e=>{e.forEach(e=>{o(e.isIntersecting)})},{threshold:.5});return f.current&&e.observe(f.current),()=>{e.disconnect()}}},[e]),x.useEffect(()=>{if(r){let e=setTimeout(()=>{o(!0)},100);return()=>{clearTimeout(e)}}},[r]);let p=()=>{i(!0)},m=()=>{i(!1),o(!1)};return n?e===`intent`?[a,f,{onFocus:wn(s,p),onBlur:wn(c,m),onMouseEnter:wn(l,p),onMouseLeave:wn(u,m),onTouchStart:wn(d,p)}]:[a,f,{}]:[!1,f,{}]}function wn(e,t){return n=>{e&&e(n),n.defaultPrevented||t(n)}}function Tn({page:e,...t}){let n=nt(),{nonce:r}=Sn(),{router:i}=yn(),a=x.useMemo(()=>O(i.routes,e,i.basename),[i.routes,e,i.basename]);return a?(t.nonce==null&&r&&(t={...t,nonce:r}),n?x.createElement(Dn,{page:e,matches:a,...t}):x.createElement(On,{page:e,matches:a,...t})):null}function En(e){let{manifest:t,routeModules:n}=Sn(),[r,i]=x.useState([]);return x.useEffect(()=>{let r=!1;return pn(e,t,n).then(e=>{r||i(e)}),()=>{r=!0}},[e,t,n]),r}function Dn({page:e,matches:t,...n}){let r=_t(),{future:i}=Sn(),{basename:a}=yn(),o=x.useMemo(()=>{if(e===r.pathname+r.search+r.hash)return[];let n=ln(e,a,i.v8_trailingSlashAwareDataRequests,`rsc`),o=!1,s=[];for(let e of t)typeof e.route.shouldRevalidate==`function`?o=!0:s.push(e.route.id);return o&&s.length>0&&n.searchParams.set(`_routes`,s.join(`,`)),[n.pathname+n.search]},[a,i.v8_trailingSlashAwareDataRequests,e,r,t]);return x.createElement(x.Fragment,null,o.map(e=>x.createElement(`link`,{key:e,rel:`prefetch`,as:`fetch`,href:e,...n})))}function On({page:e,matches:t,...n}){let r=_t(),{future:i,manifest:a,routeModules:o}=Sn(),{basename:s}=yn(),{loaderData:c,matches:l}=bn(),u=x.useMemo(()=>mn(e,t,l,a,r,`data`),[e,t,l,a,r]),d=x.useMemo(()=>mn(e,t,l,a,r,`assets`),[e,t,l,a,r]),f=x.useMemo(()=>{if(e===r.pathname+r.search+r.hash)return[];let n=new Set,l=!1;if(t.forEach(e=>{let t=a.routes[e.route.id];!t||!t.hasLoader||(!u.some(t=>t.route.id===e.route.id)&&e.route.id in c&&o[e.route.id]?.shouldRevalidate||t.hasClientLoader?l=!0:n.add(e.route.id))}),n.size===0)return[];let d=ln(e,s,i.v8_trailingSlashAwareDataRequests,`data`);return l&&n.size>0&&d.searchParams.set(`_routes`,t.filter(e=>n.has(e.route.id)).map(e=>e.route.id).join(`,`)),[d.pathname+d.search]},[s,i.v8_trailingSlashAwareDataRequests,c,r,a,u,t,e,o]),p=x.useMemo(()=>hn(d,a),[d,a]),m=En(d);return x.createElement(x.Fragment,null,f.map(e=>x.createElement(`link`,{key:e,rel:`prefetch`,as:`fetch`,href:e,...n})),p.map(e=>x.createElement(`link`,{key:e,rel:`modulepreload`,href:e,...n})),m.map(({key:e,link:t})=>x.createElement(`link`,{key:e,nonce:n.nonce,...t,crossOrigin:t.crossOrigin??n.crossOrigin})))}function kn(...e){return t=>{e.forEach(e=>{typeof e==`function`?e(t):e!=null&&(e.current=t)})}}x.Component;var An=typeof window<`u`&&window.document!==void 0&&window.document.createElement!==void 0;try{An&&(window.__reactRouterVersion=`7.18.3`)}catch{}function jn({basename:e,children:t,useTransitions:n,window:r}){let i=x.useRef();i.current??=ne({window:r,v5Compat:!0});let a=i.current,[o,s]=x.useState({action:a.action,location:a.location}),c=x.useCallback(e=>{n===!1?s(e):x.startTransition(()=>s(e))},[n]);return x.useLayoutEffect(()=>a.listen(c),[a,c]),x.createElement(Ut,{basename:e,children:t,location:o.location,navigationType:o.action,navigator:a,useTransitions:n})}var Mn=x.forwardRef(function({onClick:e,discover:t=`render`,prefetch:n=`none`,relative:r,reloadDocument:i,replace:a,mask:o,state:s,target:c,to:l,preventScrollReset:u,viewTransition:d,defaultShouldRevalidate:f,...p},m){let{basename:h,navigator:g,useTransitions:_}=x.useContext(ot),v=typeof l==`string`&&ee.test(l),y=Ue(l,h);l=y.to;let b=ht(l,{relative:r}),S=_t(),C=null;if(o){let e=Me(o,[],S.mask?S.mask.pathname:`/`,!0);h!==`/`&&(e.pathname=e.pathname===`/`?h:Pe([h,e.pathname])),C=g.createHref(e)}let[w,te,ne]=Cn(n,p),T=Ln(l,{replace:a,mask:o,state:s,target:c,preventScrollReset:u,relative:r,viewTransition:d,defaultShouldRevalidate:f,useTransitions:_});function E(t){e&&e(t),t.defaultPrevented||T(t)}let re=!(y.isExternal||i),ie=x.createElement(`a`,{...p,...ne,href:(re?C:void 0)||y.absoluteURL||b,onClick:re?E:e,ref:kn(m,te),target:c,"data-discover":!v&&t===`render`?`true`:void 0});return w&&!v?x.createElement(x.Fragment,null,ie,x.createElement(Tn,{page:b})):ie});Mn.displayName=`Link`;var Nn=x.forwardRef(function({"aria-current":e=`page`,caseSensitive:t=!1,className:n=``,end:r=!1,style:i,to:a,viewTransition:o,children:s,...c},l){let u=St(a,{relative:c.relative}),d=_t(),f=x.useContext(et),{navigator:p,basename:m}=x.useContext(ot),h=f!=null&&Un(u)&&o===!0,g=p.encodeLocation?p.encodeLocation(u).pathname:u.pathname,_=d.pathname,v=f&&f.navigation&&f.navigation.location?f.navigation.location.pathname:null;t||(_=_.toLowerCase(),v=v?v.toLowerCase():null,g=g.toLowerCase()),v&&m&&(v=Ee(v,m)||v);let y=g!==`/`&&g.endsWith(`/`)?g.length-1:g.length,b=_===g||!r&&_.startsWith(g)&&_.charAt(y)===`/`,ee=v!=null&&(v===g||!r&&v.startsWith(g)&&v.charAt(g.length)===`/`),S={isActive:b,isPending:ee,isTransitioning:h},C=b?e:void 0,w;w=typeof n==`function`?n(S):[n,b?`active`:null,ee?`pending`:null,h?`transitioning`:null].filter(Boolean).join(` `);let te=typeof i==`function`?i(S):i;return x.createElement(Mn,{...c,"aria-current":C,className:w,ref:l,style:te,to:a,viewTransition:o},typeof s==`function`?s(S):s)});Nn.displayName=`NavLink`;var Pn=x.forwardRef(({discover:e=`render`,fetcherKey:t,navigate:n,reloadDocument:r,replace:i,state:a,method:o=Kt,action:s,onSubmit:c,relative:l,preventScrollReset:u,viewTransition:d,defaultShouldRevalidate:f,...p},m)=>{let{useTransitions:h}=x.useContext(ot),g=Vn(),_=Hn(s,{relative:l}),v=o.toLowerCase()===`get`?`get`:`post`,y=typeof s==`string`&&ee.test(s);return x.createElement(`form`,{ref:m,method:v,action:_,onSubmit:r?c:e=>{if(c&&c(e),e.defaultPrevented)return;e.preventDefault();let r=e.nativeEvent.submitter,s=r?.getAttribute(`formmethod`)||o,p=()=>g(r||e.currentTarget,{fetcherKey:t,method:s,navigate:n,replace:i,state:a,relative:l,preventScrollReset:u,viewTransition:d,defaultShouldRevalidate:f});h&&n!==!1?x.startTransition(()=>p()):p()},...p,"data-discover":!y&&e===`render`?`true`:void 0})});Pn.displayName=`Form`;function Fn(e){return`${e} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function In(e){let t=x.useContext($e);return T(t,Fn(e)),t}function Ln(e,{target:t,replace:n,mask:r,state:i,preventScrollReset:a,relative:o,viewTransition:s,defaultShouldRevalidate:c,useTransitions:l}={}){let u=bt(),d=_t(),f=St(e,{relative:o});return x.useCallback(p=>{if($t(p,t)){p.preventDefault();let t=n===void 0?oe(d)===oe(f):n,m=()=>u(e,{replace:t,mask:r,state:i,preventScrollReset:a,relative:o,viewTransition:s,defaultShouldRevalidate:c});l?x.startTransition(()=>m()):m()}},[d,u,f,n,r,i,t,e,a,o,s,c,l])}function Rn(e){E(typeof URLSearchParams<`u`,"You cannot use the `useSearchParams` hook in a browser that does not support the URLSearchParams API. If you need to support Internet Explorer 11, we recommend you load a polyfill such as https://github.com/ungap/url-search-params.");let t=x.useRef(en(e)),n=x.useRef(!1),r=_t(),i=x.useMemo(()=>tn(r.search,n.current?null:t.current),[r.search]),a=bt();return[i,x.useCallback((e,t)=>{let r=en(typeof e==`function`?e(new URLSearchParams(i)):e);n.current=!0,a(`?`+r,t)},[a,i])]}var zn=0,Bn=()=>`__${String(++zn)}__`;function Vn(){let{router:e}=In(`useSubmit`),{basename:t}=x.useContext(ot),n=It(),r=e.fetch,i=e.navigate;return x.useCallback(async(e,a={})=>{let{action:o,method:s,encType:c,formData:l,body:u}=sn(e,t);if(a.navigate===!1){let e=a.fetcherKey||Bn();await r(e,n,a.action||o,{defaultShouldRevalidate:a.defaultShouldRevalidate,preventScrollReset:a.preventScrollReset,formData:l,body:u,formMethod:a.method||s,formEncType:a.encType||c,flushSync:a.flushSync})}else await i(a.action||o,{defaultShouldRevalidate:a.defaultShouldRevalidate,preventScrollReset:a.preventScrollReset,formData:l,body:u,formMethod:a.method||s,formEncType:a.encType||c,replace:a.replace,state:a.state,fromRouteId:n,flushSync:a.flushSync,viewTransition:a.viewTransition})},[r,i,t,n])}function Hn(e,{relative:t}={}){let{basename:n}=x.useContext(ot),r=x.useContext(ct);T(r,`useFormAction must be used inside a RouteContext`);let[i]=r.matches.slice(-1),a={...St(e||`.`,{relative:t})},o=_t();if(e==null){a.search=o.search;let e=new URLSearchParams(a.search),t=e.getAll(`index`);if(t.some(e=>e===``)){e.delete(`index`),t.filter(e=>e).forEach(t=>e.append(`index`,t));let n=e.toString();a.search=n?`?${n}`:``}}return(!e||e===`.`)&&i.route.index&&(a.search=a.search?a.search.replace(/^\?/,`?index&`):`?index`),n!==`/`&&(a.pathname=a.pathname===`/`?n:Pe([n,a.pathname])),oe(a)}function Un(e,{relative:t}={}){let n=x.useContext(rt);T(n!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:r}=In(`useViewTransitionState`),i=St(e,{relative:t});if(!n.isTransitioning)return!1;let a=Ee(n.currentLocation.pathname,r)||n.currentLocation.pathname,o=Ee(n.nextLocation.pathname,r)||n.nextLocation.pathname;return Se(i.pathname,o)!=null||Se(i.pathname,a)!=null}var Wn=o((e=>{var t=Symbol.for(`react.transitional.element`),n=Symbol.for(`react.fragment`);function r(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.Fragment=n,e.jsx=r,e.jsxs=r})),Gn=o(((e,t)=>{t.exports=Wn()})),Kn=c(g(),1),M=Gn(),qn={en:{brand_name:`Ludova`,brand_subtitle:`Games Discovery`,nav_ludova_hub:`← Ludova Hub`,nav_discover:`Discover`,nav_series:`Game Series`,nav_library:`All Games`,nav_feedback:`Feedback`,nav_about:`About`,lang_btn_text:`العربية`,hero_badge:`Smart Game Discovery`,hero_title_prefix:`Find Games That Match Your`,hero_title_highlight:`Exact Taste`,hero_subtitle:`Discover your next favorite game using Steam community reviews, gameplay tags, and story timelines.`,search_placeholder:`Search any game (supports GTA, DS3, RE4, GoW)...`,search_btn:`Discover`,recent_searches_title:`Recent Searches`,clear_recent:`Clear`,single_mode_label:`Single Game`,blend_mode_label:`Mix Games (Taste Fusion)`,blend_mode_hint:`Add up to 4 games to find titles that combine their gameplay, style, and tone.`,blend_add_placeholder:`Add game to mix (e.g. GTA V, Cyberpunk, Witcher 3)...`,blend_btn:`Mix & Discover`,blend_target_title:`Blended Games`,blend_selected_games:`Games in the Mix`,blend_remove:`Remove`,blend_max_reached:`Maximum 4 games can be mixed`,loading_searching:`Analyzing Steam community reviews and gameplay tags...`,error_not_found_title:`Game Not Found in Database`,error_not_found_desc:`We couldn’t find recommendations for this title yet. Try another game or check the All Games database.`,error_generic:`An unexpected error occurred while communicating with the server.`,try_again:`Try Again`,share_results:`Share Search`,link_copied:`Link Copied to Clipboard!`,target_badge:`Selected Game`,recommendations_title:`Top Recommended Games`,recommendations_count:`matches found`,match_score:`Match Score`,view_steam:`Steam`,find_similar:`Find Similar`,view_series:`View Series`,ai_summary_btn:`Player Reviews Summary`,mature_warning:`18+ Mature`,mainline_badge:`Mainline`,spinoff_badge:`Spin-off`,ai_modal_title:`Steam Player Reviews Summary`,ai_analyzing:`Analyzing player reviews from Steam in real time...`,ai_pros:`What Players Loved (Pros)`,ai_cons:`What Players Disliked (Cons)`,ai_source:`Source`,ai_source_groq:`Live Review Analysis`,ai_source_cache:`Verified Community Summary`,series_hero_badge:`Series & Sequels`,series_title_prefix:`Game Series &`,series_title_highlight:`Story Order`,series_subtitle:`Explore gaming franchises in their true chronological story order and release sequence.`,series_search_placeholder:`Search a series (e.g. Dark Souls, Resident Evil, God of War)...`,mainline_toggle_label:`Mainline Canon Games Only`,timeline_chronological_order:`Story Order #`,timeline_release_date:`Release Date`,series_empty_title:`Choose a Game Series`,series_empty_desc:`Select a series above to see all its games in chronological story order.`,library_hero_badge:`All Games Index`,library_title_prefix:`Complete Games`,library_title_highlight:`Catalog`,library_subtitle:`Browse all games in the database with instant search and pagination.`,total_games_label:`Total Indexed Games`,library_search_placeholder:`Filter games by name...`,library_no_match:`No games matched your query.`,feedback_hero_badge:`Community Voice`,feedback_title_prefix:`Share Your Experience with`,feedback_title_highlight:`Ludova`,feedback_subtitle:`Your suggestions help us improve recommendations and add new games and series.`,feedback_rating_label:`Your Rating`,feedback_text_label:`Your Thoughts & Suggestions`,feedback_placeholder:`What did you like? What features or franchises should we add next?`,feedback_submit_btn:`Submit Feedback`,feedback_submitting:`Submitting...`,feedback_success_title:`Thank You for Your Feedback!`,feedback_success_desc:`Your review has been recorded and will guide our next updates.`,feedback_send_another:`Send Another Note`,feedback_wall_title:`Recent Player Reviews`,feedback_wall_subtitle:`Real feedback shared by gamers using Ludova.`,feedback_no_reviews:`No reviews yet. Be the first to share your thoughts!`,about_modal_title:`About Ludova Games`,about_subtitle:`v2.5 • AI Neural Recommendation Engine`,about_p1:`Ludova Games is an intelligent discovery platform powered by advanced Machine Learning. Instead of relying on generic genres, our neural recommendation engine deeply analyzes Steam community reviews, gameplay tags, and player affinities to deliver spot-on matches for your favorite titles.`,about_p2:`Explore single games with fine-tuned affinity tiers, blend multiple games using Taste Fusion, browse complete game series in their true story chronology, or get instant AI-powered Steam review summaries—all wrapped in a fast, fully mobile-responsive interface.`,about_feat_ml_title:`Game Recommendation Engine`,about_feat_ml_desc:`Uses machine learning to find similar games from thousands of Steam titles, comparing game information to suggest titles with similar content and features.`,about_feat_warmup_title:`Smart In-Memory Caching`,about_feat_warmup_desc:`High-performance 24h caching reduces server overhead and delivers instant repeat discoveries.`,about_feat_fusion_title:`Taste Fusion & Franchise Timelines`,about_feat_fusion_desc:`Blend multiple titles to discover hybrid gems, or navigate iconic franchises in chronological narrative order.`,about_team_title:`Project Engineering & Contributors`,about_dev1_name:`Moaaz Ali Ali`,about_dev1_role:`Lead Developer & Software Engineer`,about_dev1_desc:`Full-stack platform architecture, ASP.NET Core APIs, UI/UX design, and database systems.`,about_dev2_name:`Abdallah Abukhalil`,about_dev2_role:`Machine Learning Engineer & Data Analyst`,about_dev2_desc:`Machine learning recommendation systems, similarity algorithms, and data-driven solutions.`,about_view_linkedin:`LinkedIn Profile`,not_found_title:`404 - Page Not Found`,not_found_desc:`The page you are looking for does not exist or has moved.`,back_home:`Back to Discovery`},ar:{brand_name:`Ludova`,brand_subtitle:`استكشاف الألعاب`,nav_ludova_hub:`← بوابة Ludova`,nav_discover:`الاستكشاف`,nav_series:`سلاسل الألعاب`,nav_library:`كل الألعاب`,nav_feedback:`التقييمات`,nav_about:`عن الموقع`,lang_btn_text:`English`,hero_badge:`استكشاف الألعاب الذكي`,hero_title_prefix:`اعثر على ألعاب تناسب`,hero_title_highlight:`ذوقك الحقيقي`,hero_subtitle:`ابحث عن ألعابك القادمة عبر تحليل مراجعات مجتمع Steam الحقيقية، والكلمات المفتاحية، وترتيب قصص السلاسل.`,search_placeholder:`ابحث عن أي لعبة (يدعم اختصارات مثل GTA, DS3, RE4, GoW)...`,search_btn:`استكشف`,recent_searches_title:`عمليات البحث الأخيرة`,clear_recent:`مسح`,single_mode_label:`بحث عن لعبة`,blend_mode_label:`دمج ألعاب متعددة (Taste Fusion)`,blend_mode_hint:`أضف حتى 4 ألعاب للعثور على ألعاب تجمع بين أساليبها وعوالمها معاً.`,blend_add_placeholder:`أضف لعبة للدمج (مثال: GTA V، Cyberpunk، Witcher 3)...`,blend_btn:`دمج واكتشاف`,blend_target_title:`الألعاب المدمجة`,blend_selected_games:`الألعاب المختارة للدمج`,blend_remove:`إزالة`,blend_max_reached:`الحد الأقصى 4 ألعاب`,loading_searching:`جاري مطابقة الألعاب وتحليل مراجعات Steam...`,error_not_found_title:`لم يتم العثور على اللعبة في قاعدة البيانات`,error_not_found_desc:`لم نتمكن من إيجاد ترشيحات لهذه اللعبة حتى الآن. جرب اسماً آخر أو تصفح قسم كل الألعاب.`,error_generic:`حدث خطأ غير متوقع أثناء الاتصال بالخادم.`,try_again:`إعادة المحاولة`,share_results:`مشاركة البحث`,link_copied:`تم نسخ الرابط إلى الحافظة!`,target_badge:`اللعبة المختارة`,recommendations_title:`أفضل الألعاب المرشحة`,recommendations_count:`ألعاب مطابقة`,match_score:`نسبة التطابق`,view_steam:`متجر Steam`,find_similar:`ألعاب مشابهة`,view_series:`عرض السلسلة`,ai_summary_btn:`ملخص مراجعات اللاعبين`,mature_warning:`18+ محتوى للبالغين`,mainline_badge:`جزء رئيسي`,spinoff_badge:`لعبة فرعية`,ai_modal_title:`ملخص مراجعات مجتمع Steam`,ai_analyzing:`جاري استخراج وتحليل مراجعات اللاعبين من Steam...`,ai_pros:`أبرز ما أعجب اللاعبين (المميزات)`,ai_cons:`أبرز انتقادات اللاعبين (العيوب)`,ai_source:`المصدر`,ai_source_groq:`تحليل مراجعات فوري`,ai_source_cache:`ملخص مجتمعي محفوظ`,series_hero_badge:`سلاسل الألعاب`,series_title_prefix:`ترتيب وقصص`,series_title_highlight:`سلاسل الألعاب`,series_subtitle:`تصفح سلاسل الألعاب بالترتيب الزمني الصحيح للقصة وتاريخ الإصدارات.`,series_search_placeholder:`ابحث عن سلسلة (مثال: Dark Souls، Resident Evil، God of War)...`,mainline_toggle_label:`الأجزاء الرئيسية للقصة فقط`,timeline_chronological_order:`ترتيب القصة #`,timeline_release_date:`تاريخ الإصدار`,series_empty_title:`اختر سلسلة ألعاب`,series_empty_desc:`اختر إحدى السلاسل لعرض جميع أجزائها بالترتيب الزمني الصحيح لأحداث القصة.`,library_hero_badge:`دليل الألعاب`,library_title_prefix:`دليل`,library_title_highlight:`كل الألعاب`,library_subtitle:`تصفح كل الألعاب الموجودة في قاعدة البيانات مع الفلترة اللحظية والتنقل بين الصفحات.`,total_games_label:`إجمالي الألعاب`,library_search_placeholder:`ابحث عن أي لعبة بالاسم...`,library_no_match:`لا توجد ألعاب مطابقة لكلمة البحث.`,feedback_hero_badge:`رأي اللاعبين`,feedback_title_prefix:`شارك برأيك في تطوير`,feedback_title_highlight:`Ludova`,feedback_subtitle:`رأيك واقتراحاتك تساعدنا على تحسين الترشيحات وإضافة سلاسل وألعاب جديدة.`,feedback_rating_label:`تقييمك للتجربة`,feedback_text_label:`رأيك واقتراحاتك`,feedback_placeholder:`ما الذي أعجبك؟ وما هي الميزات أو الألعاب التي تحب إضافتها؟`,feedback_submit_btn:`إرسال التقييم`,feedback_submitting:`جاري الإرسال...`,feedback_success_title:`شكراً لرأيك ومشاركتك!`,feedback_success_desc:`تم تسجيل تقييمك بنجاح وسنأخذ به في التحديثات القادمة.`,feedback_send_another:`إرسال تقييم آخر`,feedback_wall_title:`أحدث آراء اللاعبين`,feedback_wall_subtitle:`انطباعات حقيقية شاركها اللاعبون في Ludova.`,feedback_no_reviews:`لا توجد تقييمات بعد. كن أول من يشاركنا رأيه!`,about_modal_title:`عن موقع Ludova Games`,about_subtitle:`v2.5 • محرك ذكاء اصطناعي وتعلم آلي فائق الدقة`,about_p1:`منصة Ludova Games هي أداة ذكية لاكتشاف الألعاب مدعومة بمحرك تعلم آلي (Machine Learning) متطور. بدلاً من الاعتماد على التصنيفات السطحية، يقوم نموذج الذكاء الاصطناعي بتحليل عميق لآلاف مراجعات مجتمع Steam الحقيقية وسلوك اللاعبين وميكانيكيات اللعب لترشيح ألعاب تشبه ذوقك الحقيقي بدقة متناهية.`,about_p2:`يمكنك استكشاف ألعاب فردية بنظام تقييم التوافق المطور، أو دمج حتى 4 ألعاب بميزة (Taste Fusion) لاكتشاف ألعاب هجينة تجمع بين عوالمك المفضلة، أو تصفح سلاسل الألعاب بالترتيب الزمني الصحيح لأحداث القصة، بالإضافة لملخصات مراجعات اللاعبين الفورية — مع تجربة سلسة ومتوافقة بالكامل مع الهواتف الذكية.`,about_feat_ml_title:`محرك ترشيح الألعاب (Game Recommendation Engine)`,about_feat_ml_desc:`يستخدم التعلّم الآلي للعثور على ألعاب مشابهة من بين آلاف ألعاب Steam، بمقارنة بيانات ومواصفات الألعاب لاقتراح عناوين تشابهها في المحتوى والمميزات.`,about_feat_warmup_title:`تخزين مؤقت ذكي واستجابة فائقة`,about_feat_warmup_desc:`نظام كاش متطور يحفظ نتائج الترشيحات لتقديم استجابات فورية وتقليل استهلاك موارد الخوادم.`,about_feat_fusion_title:`دمج الألعاب والسلاسل القصصية`,about_feat_fusion_desc:`دمج أذواق ألعاب متعددة وتصفح تسلسل أجزاء السلاسل الكبرى بحسب أحداث القصة وتاريخ الإصدار.`,about_team_title:`فريق التطوير والذكاء الاصطناعي`,about_dev1_name:`معاذ علي علي (Moaaz Ali)`,about_dev1_role:`مطور المنصة وهندسة البرمجيات`,about_dev1_desc:`معمارية النظام الكاملة (Full-Stack)، تكامل خوادم ASP.NET Core، تصميم الواجهات التفاعلية وإدارة قواعد البيانات.`,about_dev2_name:`عبد الله أبو خليل (Abdallah Abukhalil)`,about_dev2_role:`Machine Learning Engineer & Data Analyst`,about_dev2_desc:`أنظمة ترشيح قائمة على التعلّم الآلي، وخوارزميات قياس التشابه، وحلول برمجية مدفوعة بالبيانات (Data-driven solutions).`,about_view_linkedin:`حساب LinkedIn`,not_found_title:`404 - الصفحة غير موجودة`,not_found_desc:`الصفحة التي تبحث عنها غير موجودة أو تم نقلها.`,back_home:`العودة للاستكشاف`}},Jn=(0,x.createContext)(),Yn=({children:e})=>{let[t,n]=(0,x.useState)(()=>localStorage.getItem(`ludova_lang`)||`en`);return(0,x.useEffect)(()=>{localStorage.setItem(`ludova_lang`,t),document.documentElement.lang=t,document.documentElement.dir=t===`ar`?`rtl`:`ltr`,t===`ar`?document.body.classList.add(`rtl-mode`):document.body.classList.remove(`rtl-mode`)},[t]),(0,M.jsx)(Jn.Provider,{value:{lang:t,isRTL:t===`ar`,toggleLanguage:()=>{n(e=>e===`en`?`ar`:`en`)},t:e=>qn[t]?.[e]||qn.en?.[e]||e},children:e})},Xn=()=>(0,x.useContext)(Jn),Zn=(...e)=>e.filter((e,t,n)=>!!e&&e.trim()!==``&&n.indexOf(e)===t).join(` `).trim(),Qn=e=>e.replace(/([a-z0-9])([A-Z])/g,`$1-$2`).toLowerCase(),$n=e=>e.replace(/^([A-Z])|[\s-_]+(\w)/g,(e,t,n)=>n?n.toUpperCase():t.toLowerCase()),er=e=>{let t=$n(e);return t.charAt(0).toUpperCase()+t.slice(1)},tr={xmlns:`http://www.w3.org/2000/svg`,width:24,height:24,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:2,strokeLinecap:`round`,strokeLinejoin:`round`},nr=e=>{for(let t in e)if(t.startsWith(`aria-`)||t===`role`||t===`title`)return!0;return!1},rr=(0,x.createContext)({}),ir=()=>(0,x.useContext)(rr),ar=(0,x.forwardRef)(({color:e,size:t,strokeWidth:n,absoluteStrokeWidth:r,className:i=``,children:a,iconNode:o,...s},c)=>{let{size:l=24,strokeWidth:u=2,absoluteStrokeWidth:d=!1,color:f=`currentColor`,className:p=``}=ir()??{},m=r??d?Number(n??u)*24/Number(t??l):n??u;return(0,x.createElement)(`svg`,{ref:c,...tr,width:t??l??tr.width,height:t??l??tr.height,stroke:e??f,strokeWidth:m,className:Zn(`lucide`,p,i),...!a&&!nr(s)&&{"aria-hidden":`true`},...s},[...o.map(([e,t])=>(0,x.createElement)(e,t)),...Array.isArray(a)?a:[a]])}),N=(e,t)=>{let n=(0,x.forwardRef)(({className:n,...r},i)=>(0,x.createElement)(ar,{ref:i,iconNode:t,className:Zn(`lucide-${Qn(er(e))}`,`lucide-${e}`,n),...r}));return n.displayName=er(e),n},or=N(`arrow-left`,[[`path`,{d:`m12 19-7-7 7-7`,key:`1l729n`}],[`path`,{d:`M19 12H5`,key:`x3x0zl`}]]),sr=N(`arrow-right`,[[`path`,{d:`M5 12h14`,key:`1ays0h`}],[`path`,{d:`m12 5 7 7-7 7`,key:`xquz4c`}]]),cr=N(`calendar`,[[`path`,{d:`M8 2v3`,key:`1ioesn`}],[`path`,{d:`M16 2v3`,key:`otl347`}],[`rect`,{x:`3`,y:`3`,width:`18`,height:`18`,rx:`2`,key:`h1oib`}],[`path`,{d:`M3 9h18`,key:`1pudct`}]]),lr=N(`check`,[[`path`,{d:`M20 6 9 17l-5-5`,key:`1gmf2c`}]]),ur=N(`chevron-down`,[[`path`,{d:`m6 9 6 6 6-6`,key:`qrunsl`}]]),dr=N(`chevron-left`,[[`path`,{d:`m15 18-6-6 6-6`,key:`1wnfg3`}]]),fr=N(`chevron-right`,[[`path`,{d:`m9 18 6-6-6-6`,key:`mthhwq`}]]),pr=N(`chevron-up`,[[`path`,{d:`m18 15-6-6-6 6`,key:`153udz`}]]),mr=N(`chevrons-left`,[[`path`,{d:`m11 17-5-5 5-5`,key:`13zhaf`}],[`path`,{d:`m18 17-5-5 5-5`,key:`h8a8et`}]]),hr=N(`chevrons-right`,[[`path`,{d:`m6 17 5-5-5-5`,key:`xnjwq`}],[`path`,{d:`m13 17 5-5-5-5`,key:`17xmmf`}]]),gr=N(`circle-alert`,[[`circle`,{cx:`12`,cy:`12`,r:`10`,key:`1mglay`}],[`line`,{x1:`12`,x2:`12`,y1:`8`,y2:`12`,key:`1pkeuh`}],[`line`,{x1:`12`,x2:`12.01`,y1:`16`,y2:`16`,key:`4dfq90`}]]),_r=N(`circle-check`,[[`circle`,{cx:`12`,cy:`12`,r:`10`,key:`1mglay`}],[`path`,{d:`m16 9-5.5 5.5L8 12`,key:`xofnsj`}]]),vr=N(`code-xml`,[[`path`,{d:`m18 16 4-4-4-4`,key:`1inbqp`}],[`path`,{d:`m6 8-4 4 4 4`,key:`15zrgr`}],[`path`,{d:`m14.5 4-5 16`,key:`e7oirm`}]]),yr=N(`compass`,[[`circle`,{cx:`12`,cy:`12`,r:`10`,key:`1mglay`}],[`path`,{d:`m16.24 7.76-1.804 5.411a2 2 0 0 1-1.265 1.265L7.76 16.24l1.804-5.411a2 2 0 0 1 1.265-1.265z`,key:`9ktpf1`}]]),br=N(`cpu`,[[`path`,{d:`M12 20v2`,key:`1lh1kg`}],[`path`,{d:`M12 2v2`,key:`tus03m`}],[`path`,{d:`M17 20v2`,key:`1rnc9c`}],[`path`,{d:`M17 2v2`,key:`11trls`}],[`path`,{d:`M2 12h2`,key:`1t8f8n`}],[`path`,{d:`M2 17h2`,key:`7oei6x`}],[`path`,{d:`M2 7h2`,key:`asdhe0`}],[`path`,{d:`M20 12h2`,key:`1q8mjw`}],[`path`,{d:`M20 17h2`,key:`1fpfkl`}],[`path`,{d:`M20 7h2`,key:`1o8tra`}],[`path`,{d:`M7 20v2`,key:`4gnj0m`}],[`path`,{d:`M7 2v2`,key:`1i4yhu`}],[`rect`,{x:`4`,y:`4`,width:`16`,height:`16`,rx:`2`,key:`1vbyd7`}],[`rect`,{x:`8`,y:`8`,width:`8`,height:`8`,rx:`1`,key:`z9xiuo`}]]),xr=N(`database`,[[`ellipse`,{cx:`12`,cy:`5`,rx:`9`,ry:`3`,key:`msslwz`}],[`path`,{d:`M3 5V19A9 3 0 0 0 21 19V5`,key:`1wlel7`}],[`path`,{d:`M3 12A9 3 0 0 0 21 12`,key:`mv7ke4`}]]),Sr=N(`external-link`,[[`path`,{d:`M15 3h6v6`,key:`1q9fwt`}],[`path`,{d:`M10 14 21 3`,key:`gplh6r`}],[`path`,{d:`M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6`,key:`a6xqqp`}]]),Cr=N(`git-merge`,[[`circle`,{cx:`18`,cy:`18`,r:`3`,key:`1xkwt0`}],[`circle`,{cx:`6`,cy:`6`,r:`3`,key:`1lh9wr`}],[`path`,{d:`M6 21V9a9 9 0 0 0 9 9`,key:`7kw0sc`}]]),wr=N(`globe`,[[`circle`,{cx:`12`,cy:`12`,r:`10`,key:`1mglay`}],[`path`,{d:`M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20`,key:`13o1zl`}],[`path`,{d:`M2 12h20`,key:`9i4pu4`}]]),Tr=N(`info`,[[`circle`,{cx:`12`,cy:`12`,r:`10`,key:`1mglay`}],[`path`,{d:`M12 16v-4`,key:`1dtifu`}],[`path`,{d:`M12 8h.01`,key:`e9boi3`}]]),Er=N(`layers`,[[`path`,{d:`M12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.58 3.91a2 2 0 0 0 1.66 0l8.58-3.9a1 1 0 0 0 0-1.83z`,key:`zw3jo`}],[`path`,{d:`M2 12a1 1 0 0 0 .58.91l8.6 3.91a2 2 0 0 0 1.65 0l8.58-3.9A1 1 0 0 0 22 12`,key:`1wduqc`}],[`path`,{d:`M2 17a1 1 0 0 0 .58.91l8.6 3.91a2 2 0 0 0 1.65 0l8.58-3.9A1 1 0 0 0 22 17`,key:`kqbvx6`}]]),Dr=N(`menu`,[[`path`,{d:`M4 5h16`,key:`1tepv9`}],[`path`,{d:`M4 12h16`,key:`1lakjw`}],[`path`,{d:`M4 19h16`,key:`1djgab`}]]),Or=N(`message-circle`,[[`path`,{d:`M2.992 16.342a2 2 0 0 1 .094 1.167l-1.065 3.29a1 1 0 0 0 1.236 1.168l3.413-.998a2 2 0 0 1 1.099.092 10 10 0 1 0-4.777-4.719`,key:`1sd12s`}]]),kr=N(`message-square-quote`,[[`path`,{d:`M14 14a2 2 0 0 0 2-2V8h-2`,key:`1r06pg`}],[`path`,{d:`M22 17a2 2 0 0 1-2 2H6.828a2 2 0 0 0-1.414.586l-2.202 2.202A.71.71 0 0 1 2 21.286V5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2z`,key:`18887p`}],[`path`,{d:`M8 14a2 2 0 0 0 2-2V8H8`,key:`1jzu5j`}]]),Ar=N(`plus`,[[`path`,{d:`M5 12h14`,key:`1ays0h`}],[`path`,{d:`M12 5v14`,key:`s699le`}]]),jr=N(`refresh-cw`,[[`path`,{d:`M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8`,key:`v9h5vc`}],[`path`,{d:`M21 3v5h-5`,key:`1q7to0`}],[`path`,{d:`M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16`,key:`3uifl3`}],[`path`,{d:`M8 16H3v5`,key:`1cv678`}]]),Mr=N(`rotate-ccw-clock`,[[`path`,{d:`M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8`,key:`1357e3`}],[`path`,{d:`M3 3v5h5`,key:`1xhq8a`}],[`path`,{d:`M12 7v5l4 2`,key:`1fdv2h`}]]),Nr=N(`search`,[[`path`,{d:`m21 21-4.34-4.34`,key:`14j7rj`}],[`circle`,{cx:`11`,cy:`11`,r:`8`,key:`4ej97u`}]]),Pr=N(`send`,[[`path`,{d:`M14.536 21.686a.5.5 0 0 0 .937-.024l6.5-19a.496.496 0 0 0-.635-.635l-19 6.5a.5.5 0 0 0-.024.937l7.93 3.18a2 2 0 0 1 1.112 1.11z`,key:`1ffxy3`}],[`path`,{d:`m21.854 2.147-10.94 10.939`,key:`12cjpa`}]]),Fr=N(`share-2`,[[`circle`,{cx:`18`,cy:`5`,r:`3`,key:`gq8acd`}],[`circle`,{cx:`6`,cy:`12`,r:`3`,key:`w7nqdw`}],[`circle`,{cx:`18`,cy:`19`,r:`3`,key:`1xt0gg`}],[`line`,{x1:`8.59`,x2:`15.42`,y1:`13.51`,y2:`17.49`,key:`47mynk`}],[`line`,{x1:`15.41`,x2:`8.59`,y1:`6.51`,y2:`10.49`,key:`1n3mei`}]]),Ir=N(`shield-alert`,[[`path`,{d:`M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z`,key:`oel41y`}],[`path`,{d:`M12 8v4`,key:`1got3b`}],[`path`,{d:`M12 16h.01`,key:`1drbdi`}]]),Lr=N(`sliders-horizontal`,[[`path`,{d:`M10 5H3`,key:`1qgfaw`}],[`path`,{d:`M12 19H3`,key:`yhmn1j`}],[`path`,{d:`M14 3v4`,key:`1sua03`}],[`path`,{d:`M16 17v4`,key:`1q0r14`}],[`path`,{d:`M21 12h-9`,key:`1o4lsq`}],[`path`,{d:`M21 19h-5`,key:`1rlt1p`}],[`path`,{d:`M21 5h-7`,key:`1oszz2`}],[`path`,{d:`M8 10v4`,key:`tgpxqk`}],[`path`,{d:`M8 12H3`,key:`a7s4jb`}]]),Rr=N(`sparkles`,[[`path`,{d:`M11.017 2.814a1 1 0 0 1 1.966 0l1.051 5.558a2 2 0 0 0 1.594 1.594l5.558 1.051a1 1 0 0 1 0 1.966l-5.558 1.051a2 2 0 0 0-1.594 1.594l-1.051 5.558a1 1 0 0 1-1.966 0l-1.051-5.558a2 2 0 0 0-1.594-1.594l-5.558-1.051a1 1 0 0 1 0-1.966l5.558-1.051a2 2 0 0 0 1.594-1.594z`,key:`1s2grr`}],[`path`,{d:`M20 2v4`,key:`1rf3ol`}],[`path`,{d:`M22 4h-4`,key:`gwowj6`}],[`circle`,{cx:`4`,cy:`20`,r:`2`,key:`6kqj1y`}]]),zr=N(`star`,[[`path`,{d:`M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.123 2.123 0 0 0-.611 1.878l.882 5.14a.53.53 0 0 1-.771.56l-4.618-2.428a2.122 2.122 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z`,key:`r04s7s`}]]),Br=N(`terminal`,[[`path`,{d:`M12 19h8`,key:`baeox8`}],[`path`,{d:`m4 17 6-6-6-6`,key:`1yngyt`}]]),Vr=N(`triangle-alert`,[[`path`,{d:`m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3`,key:`wmoenq`}],[`path`,{d:`M12 9v4`,key:`juzpu7`}],[`path`,{d:`M12 17h.01`,key:`p32p05`}]]),Hr=N(`user`,[[`path`,{d:`M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2`,key:`975kel`}],[`circle`,{cx:`12`,cy:`7`,r:`4`,key:`17ys0d`}]]),Ur=N(`users`,[[`path`,{d:`M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2`,key:`1yyitq`}],[`path`,{d:`M16 3.128a4 4 0 0 1 0 7.744`,key:`16gr8j`}],[`path`,{d:`M22 21v-2a4 4 0 0 0-3-3.87`,key:`kshegd`}],[`circle`,{cx:`9`,cy:`7`,r:`4`,key:`nufk8`}]]),Wr=N(`x`,[[`path`,{d:`M18 6 6 18`,key:`1bl5f8`}],[`path`,{d:`m6 6 12 12`,key:`d8bk6v`}]]),Gr=({onOpenAbout:e})=>{let{lang:t,toggleLanguage:n,t:r}=Xn(),[i,a]=(0,x.useState)(!1),[o,s]=(0,x.useState)(!1);(0,x.useEffect)(()=>{let e=()=>{a(window.scrollY>20)};return window.addEventListener(`scroll`,e),()=>window.removeEventListener(`scroll`,e)},[]);let c=()=>s(!1);return(0,M.jsxs)(`header`,{className:`navbar-root ${i?`navbar--scrolled`:``}`,children:[(0,M.jsxs)(`div`,{className:`navbar-container`,children:[(0,M.jsxs)(`div`,{className:`navbar-left-cluster`,children:[(0,M.jsx)(`a`,{href:`https://ludova.runasp.net/`,className:`umbrella-gateway-link`,title:`Ludova Umbrella Platform`,children:r(`nav_ludova_hub`)}),(0,M.jsxs)(Mn,{to:`/`,className:`navbar-brand`,onClick:c,children:[(0,M.jsx)(`div`,{className:`navbar-brand-icon`,children:(0,M.jsx)(`img`,{src:`/ludova-logo.svg`,alt:`Ludova Logo`,className:`brand-logo-img`})}),(0,M.jsxs)(`div`,{className:`navbar-brand-text`,children:[(0,M.jsx)(`span`,{className:`brand-title`,children:r(`brand_name`)}),(0,M.jsx)(`span`,{className:`brand-subtitle`,children:r(`brand_subtitle`)})]})]})]}),(0,M.jsxs)(`nav`,{className:`navbar-links-desktop`,children:[(0,M.jsxs)(Nn,{to:`/`,className:({isActive:e})=>`nav-link ${e?`nav-link--active`:``}`,end:!0,children:[(0,M.jsx)(yr,{size:17}),(0,M.jsx)(`span`,{children:r(`nav_discover`)})]}),(0,M.jsxs)(Nn,{to:`/series`,className:({isActive:e})=>`nav-link ${e?`nav-link--active`:``}`,children:[(0,M.jsx)(Cr,{size:17}),(0,M.jsx)(`span`,{children:r(`nav_series`)})]}),(0,M.jsxs)(Nn,{to:`/library`,className:({isActive:e})=>`nav-link ${e?`nav-link--active`:``}`,children:[(0,M.jsx)(xr,{size:17}),(0,M.jsx)(`span`,{children:r(`nav_library`)})]}),(0,M.jsxs)(Nn,{to:`/feedback`,className:({isActive:e})=>`nav-link ${e?`nav-link--active`:``}`,children:[(0,M.jsx)(kr,{size:17}),(0,M.jsx)(`span`,{children:r(`nav_feedback`)})]})]}),(0,M.jsxs)(`div`,{className:`navbar-actions`,children:[(0,M.jsxs)(`button`,{type:`button`,className:`nav-action-btn`,onClick:e,title:r(`nav_about`),children:[(0,M.jsx)(Tr,{size:17}),(0,M.jsx)(`span`,{className:`nav-action-label`,children:r(`nav_about`)})]}),(0,M.jsxs)(`button`,{type:`button`,className:`nav-action-btn lang-toggle-btn`,onClick:n,children:[(0,M.jsx)(wr,{size:16}),(0,M.jsx)(`span`,{className:`lang-code-tag`,children:r(`lang_btn_text`)})]}),(0,M.jsx)(`button`,{type:`button`,className:`mobile-menu-btn`,onClick:()=>s(e=>!e),"aria-label":`Toggle menu`,children:o?(0,M.jsx)(Wr,{size:22}):(0,M.jsx)(Dr,{size:22})})]})]}),o&&(0,M.jsxs)(`div`,{className:`navbar-mobile-drawer`,children:[(0,M.jsxs)(Nn,{to:`/`,className:({isActive:e})=>`mobile-nav-link ${e?`mobile-nav-link--active`:``}`,onClick:c,end:!0,children:[(0,M.jsx)(yr,{size:18}),(0,M.jsx)(`span`,{children:r(`nav_discover`)})]}),(0,M.jsxs)(Nn,{to:`/series`,className:({isActive:e})=>`mobile-nav-link ${e?`mobile-nav-link--active`:``}`,onClick:c,children:[(0,M.jsx)(Cr,{size:18}),(0,M.jsx)(`span`,{children:r(`nav_series`)})]}),(0,M.jsxs)(Nn,{to:`/library`,className:({isActive:e})=>`mobile-nav-link ${e?`mobile-nav-link--active`:``}`,onClick:c,children:[(0,M.jsx)(xr,{size:18}),(0,M.jsx)(`span`,{children:r(`nav_library`)})]}),(0,M.jsxs)(Nn,{to:`/feedback`,className:({isActive:e})=>`mobile-nav-link ${e?`mobile-nav-link--active`:``}`,onClick:c,children:[(0,M.jsx)(kr,{size:18}),(0,M.jsx)(`span`,{children:r(`nav_feedback`)})]}),(0,M.jsxs)(`a`,{href:`https://ludova.runasp.net/`,className:`mobile-nav-link mobile-umbrella-link`,onClick:c,title:`Ludova Umbrella Platform`,children:[(0,M.jsx)(Rr,{size:18,color:`var(--accent-amber)`}),(0,M.jsx)(`span`,{children:r(`nav_ludova_hub`)})]}),(0,M.jsxs)(`button`,{type:`button`,className:`mobile-nav-link`,onClick:()=>{c(),e()},children:[(0,M.jsx)(Tr,{size:18}),(0,M.jsx)(`span`,{children:r(`nav_about`)})]})]}),(0,M.jsx)(`style`,{children:`
      ...
      `})]})},Kr=c(m(),1),qr=({isOpen:e,onClose:t})=>{let{t:n}=Xn();if((0,x.useEffect)(()=>{if(!e)return;let t=document.body.style.overflow;return document.body.style.overflow=`hidden`,()=>{document.body.style.overflow=t}},[e]),!e)return null;let r=[{icon:(0,M.jsx)(br,{size:20}),title:n(`about_feat_ml_title`),desc:n(`about_feat_ml_desc`),gradient:`linear-gradient(135deg, rgba(6, 182, 212, 0.15), rgba(6, 182, 212, 0.05))`,color:`#06b6d4`},{icon:(0,M.jsx)(xr,{size:20}),title:n(`about_feat_warmup_title`),desc:n(`about_feat_warmup_desc`),gradient:`linear-gradient(135deg, rgba(234, 179, 8, 0.15), rgba(234, 179, 8, 0.05))`,color:`#eab308`},{icon:(0,M.jsx)(Cr,{size:20}),title:n(`about_feat_fusion_title`),desc:n(`about_feat_fusion_desc`),gradient:`linear-gradient(135deg, rgba(168, 85, 247, 0.15), rgba(168, 85, 247, 0.05))`,color:`#a855f7`}];return(0,Kr.createPortal)((0,M.jsxs)(`div`,{className:`modal-backdrop`,onClick:t,children:[(0,M.jsxs)(`div`,{className:`modal-surface about-modal-surface`,onClick:e=>e.stopPropagation(),children:[(0,M.jsx)(`button`,{type:`button`,className:`modal-close-btn`,onClick:t,"aria-label":`Close modal`,children:(0,M.jsx)(Wr,{size:20})}),(0,M.jsxs)(`div`,{className:`about-header`,children:[(0,M.jsx)(`div`,{className:`about-icon-box`,children:(0,M.jsx)(Rr,{size:22})}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h2`,{className:`heading-display about-title`,children:n(`about_modal_title`)}),(0,M.jsx)(`p`,{className:`about-subtitle`,children:n(`about_subtitle`)})]})]}),(0,M.jsxs)(`div`,{className:`about-body`,children:[(0,M.jsx)(`p`,{className:`about-paragraph`,children:n(`about_p1`)}),(0,M.jsx)(`p`,{className:`about-paragraph`,children:n(`about_p2`)}),(0,M.jsx)(`div`,{className:`about-features-list`,children:r.map((e,t)=>(0,M.jsxs)(`div`,{className:`about-feature-item`,style:{background:e.gradient},children:[(0,M.jsx)(`div`,{className:`about-feature-icon`,style:{color:e.color,borderColor:`${e.color}40`},children:e.icon}),(0,M.jsxs)(`div`,{className:`about-feature-content`,children:[(0,M.jsx)(`h4`,{className:`about-feature-title`,style:{color:e.color},children:e.title}),(0,M.jsx)(`p`,{className:`about-feature-desc`,children:e.desc})]})]},t))}),(0,M.jsxs)(`div`,{className:`about-team-section`,children:[(0,M.jsxs)(`div`,{className:`about-team-heading`,children:[(0,M.jsx)(Ur,{size:18,className:`team-heading-icon`}),(0,M.jsx)(`h3`,{className:`about-team-title`,children:n(`about_team_title`)})]}),(0,M.jsxs)(`div`,{className:`about-team-list`,children:[(0,M.jsxs)(`div`,{className:`team-member-card moaaz-card`,children:[(0,M.jsxs)(`div`,{className:`team-member-header`,children:[(0,M.jsx)(`div`,{className:`team-avatar-box moaaz-avatar`,children:(0,M.jsx)(vr,{size:20})}),(0,M.jsxs)(`div`,{className:`team-header-info`,children:[(0,M.jsx)(`div`,{className:`member-name-row`,children:(0,M.jsx)(`h4`,{className:`member-name highlight-amber`,children:n(`about_dev1_name`)})}),(0,M.jsx)(`span`,{className:`member-role`,children:n(`about_dev1_role`)})]})]}),(0,M.jsx)(`p`,{className:`member-desc`,children:n(`about_dev1_desc`)})]}),(0,M.jsxs)(`div`,{className:`team-member-card abdallah-card`,children:[(0,M.jsxs)(`div`,{className:`team-member-header`,children:[(0,M.jsx)(`div`,{className:`team-avatar-box abdallah-avatar`,children:(0,M.jsx)(br,{size:20})}),(0,M.jsxs)(`div`,{className:`team-header-info`,children:[(0,M.jsxs)(`div`,{className:`member-name-row`,children:[(0,M.jsx)(`h4`,{className:`member-name highlight-cyan`,children:n(`about_dev2_name`)}),(0,M.jsx)(`a`,{href:`https://www.linkedin.com/in/abdallahabukhalil/`,target:`_blank`,rel:`noopener noreferrer`,className:`member-social-link`,"aria-label":n(`about_view_linkedin`),title:n(`about_view_linkedin`),children:(0,M.jsx)(Sr,{size:13})})]}),(0,M.jsx)(`span`,{className:`member-role ml-badge`,children:n(`about_dev2_role`)})]})]}),(0,M.jsx)(`p`,{className:`member-desc`,children:n(`about_dev2_desc`)})]})]})]})]})]}),(0,M.jsx)(`style`,{children:`
        .about-modal-surface {
          max-width: 580px;
          width: 100%;
          max-height: 85vh;
      ...
      `})]}),document.body)},Jr=()=>{let{pathname:e}=_t();return(0,x.useEffect)(()=>{window.scrollTo(0,0)},[e]),null},Yr=({children:e})=>(0,M.jsx)(`div`,{className:`page-container`,children:e}),Xr=`ludova_recent_searches`,Zr=6,Qr=()=>{let[e,t]=(0,x.useState)(()=>{try{let e=localStorage.getItem(Xr);return e?JSON.parse(e):[]}catch{return[]}});return(0,x.useEffect)(()=>{try{localStorage.setItem(Xr,JSON.stringify(e))}catch(e){console.warn(`Failed to persist recent searches`,e)}},[e]),{recentSearches:e,addSearch:e=>{if(!e||typeof e!=`string`)return;let n=e.trim();n&&t(e=>{let t=e.filter(e=>e.toLowerCase()!==n.toLowerCase());return[n,...t].slice(0,Zr)})},removeSearch:e=>{t(t=>t.filter(t=>t!==e))},clearSearches:()=>{t([])}}},$r=`/api`,ei=e=>e?`https://cdn.akamai.steamstatic.com/steam/apps/${e}/header.jpg`:null,ti=async e=>{let t=encodeURIComponent(e.trim()),n=await fetch(`${$r}/Recommendations/${t}/recommendations`);if(!n.ok)throw Error(`Game not found or server error (${n.status})`);return await n.json()},ni=async e=>{if(!e||e.trim().length<2)return[];let t=encodeURIComponent(e.trim()),n=await fetch(`${$r}/Recommendations/autocomplete?q=${t}`);return n.ok?await n.json():[]},ri=async e=>{let t=await fetch(`${$r}/Recommendations/blend`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({games:e})});if(!t.ok){let e=await t.json().catch(()=>({}));throw Error(e.message||`Failed to blend game recommendations`)}return await t.json()},ii=async()=>{let e=await fetch(`${$r}/Recommendations/all`);if(!e.ok)throw Error(`Failed to load database library`);return await e.json()},ai=async()=>{let e=await fetch(`${$r}/Recommendations/stats`);if(!e.ok)throw Error(`Failed to load stats`);return await e.json()},oi=async(e,t=`en`)=>{let n=await fetch(`${$r}/reviews/${e}/ai-summary?lang=${t}`);if(!n.ok)throw Error(`Failed to generate AI review breakdown`);return await n.json()},si=async(e,t=!1)=>{let n=await fetch(`${$r}/Series/${e}/timeline?onlyMainline=${t}`);if(!n.ok)throw Error(`Failed to fetch series timeline`);return await n.json()},ci=async e=>{if(!e||e.trim().length<2)return[];let t=encodeURIComponent(e.trim()),n=await fetch(`${$r}/Series/autocomplete?q=${t}`);return n.ok?await n.json():[]},li=async()=>{let e=await fetch(`${$r}/Recommendations/feedback`);return e.ok?await e.json():[]},ui=async(e,t)=>{let n=await fetch(`${$r}/Recommendations/feedback`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({message:e.trim(),rating:Number(t)||5})});if(!n.ok)throw Error(`Failed to submit feedback`);return await n.json()},di=e=>{let[t,n]=(0,x.useState)(`rgba(244, 63, 94, 0.15)`);return(0,x.useEffect)(()=>{if(!e){n(`rgba(244, 63, 94, 0.15)`);return}let t=new Image;t.crossOrigin=`Anonymous`,t.src=e,t.onload=()=>{try{let e=document.createElement(`canvas`),r=e.getContext(`2d`);e.width=16,e.height=16,r.drawImage(t,0,0,16,16);let i=r.getImageData(0,0,16,16).data,a=0,o=0,s=0,c=0;for(let e=0;e<i.length;e+=4){let t=i[e],n=i[e+1],r=i[e+2],l=(t+n+r)/3;l>30&&l<220&&(a+=t,o+=n,s+=r,c++)}c>0&&(a=Math.round(a/c),o=Math.round(o/c),s=Math.round(s/c),n(`rgba(${a}, ${o}, ${s}, 0.25)`))}catch{n(`rgba(244, 63, 94, 0.18)`)}},t.onerror=()=>{n(`rgba(244, 63, 94, 0.15)`)}},[e]),t},fi=({targetGameName:e,targetAppId:t,hasSeries:n,seriesId:r,onOpenAiSummary:i})=>{let{t:a}=Xn(),[o,s]=(0,x.useState)(!1),[c,l]=(0,x.useState)(!1),u=t&&!c?ei(t):null,d=di(u);return(0,M.jsxs)(`section`,{className:`target-banner-root`,style:{boxShadow:`0 20px 50px -15px ${d}, var(--shadow-md)`,borderColor:d.replace(`0.25`,`0.4`).replace(`0.15`,`0.3`)},children:[(0,M.jsx)(`div`,{className:`target-banner-aura`,style:{background:`radial-gradient(circle at 20% 50%, ${d}, transparent 70%)`}}),(0,M.jsxs)(`div`,{className:`target-banner-layout`,children:[(0,M.jsx)(`div`,{className:`target-banner-cover-wrap`,children:u?(0,M.jsx)(`img`,{src:u,alt:e,className:`target-banner-cover-img`,onError:()=>l(!0)}):(0,M.jsx)(`div`,{className:`target-banner-cover-placeholder`,children:(0,M.jsx)(`span`,{children:e.slice(0,2).toUpperCase()})})}),(0,M.jsxs)(`div`,{className:`target-banner-info`,children:[(0,M.jsxs)(`div`,{className:`target-badge-row`,children:[(0,M.jsx)(`span`,{className:`target-pill`,children:a(`target_badge`)}),t&&(0,M.jsxs)(`span`,{className:`target-appid-pill`,children:[`Steam ID: `,t]})]}),(0,M.jsx)(`h2`,{className:`target-game-title heading-display`,children:e}),(0,M.jsxs)(`div`,{className:`target-actions-row`,children:[t&&(0,M.jsxs)(`button`,{type:`button`,className:`btn btn-ai`,onClick:()=>i(t,e),children:[(0,M.jsx)(Rr,{size:16}),(0,M.jsx)(`span`,{children:a(`ai_summary_btn`)})]}),n&&r&&(0,M.jsxs)(Mn,{to:`/series?id=${r}`,className:`btn btn-secondary`,children:[(0,M.jsx)(Cr,{size:16}),(0,M.jsx)(`span`,{children:a(`view_series`)})]}),t&&(0,M.jsxs)(`a`,{href:`https://store.steampowered.com/app/${t}`,target:`_blank`,rel:`noopener noreferrer`,className:`btn btn-steam-prominent`,style:{padding:`0.65rem 1.15rem`},children:[(0,M.jsx)(Sr,{size:16}),(0,M.jsx)(`span`,{children:a(`view_steam`)})]}),(0,M.jsxs)(`button`,{type:`button`,className:`btn btn-ghost`,onClick:()=>{let t=`${window.location.origin}/?search=${encodeURIComponent(e)}`;navigator.clipboard.writeText(t).then(()=>{s(!0),setTimeout(()=>s(!1),2500)})},title:a(`share_results`),children:[o?(0,M.jsx)(lr,{size:16,color:`var(--score-emerald)`}):(0,M.jsx)(Fr,{size:16}),(0,M.jsx)(`span`,{children:a(o?`link_copied`:`share_results`)})]})]})]})]}),(0,M.jsx)(`style`,{children:`
        .target-banner-root {
          position: relative;
          background: var(--bg-surface);
      ...
      `})]})},pi=({game:e,onSelectSimilar:t,onOpenAiSummary:n,isLibrary:r=!1})=>{let{t:i}=Xn(),[a,o]=(0,x.useState)(!1),s=e.appid||e.appId||e.Appid||e.TargetAppId,c=e.name||e.Name||`Unknown Title`,l=e.matchscore||e.matchScore||e.MatchScore||0,u=e.isMature||e.IsMature||!1,d=e.hasseries||e.hasSeries||!1,f=e.seriesid||e.seriesId,p=e.similarityScore??e.SimilarityScore??e.similarity_score,m=[],h=e.tags||e.Tags||[];typeof h==`string`?m=h.split(`,`).map(e=>e.trim()).filter(Boolean):Array.isArray(h)&&(m=h);let g=`score-badge--fair`,_=``;p==null?(g=l>=20?`score-badge--mythic`:l>=15?`score-badge--legendary`:l>=10?`score-badge--epic`:l>=6?`score-badge--rare`:l>=3?`score-badge--good`:`score-badge--fair`,_=`${i(`match_score`)}: ${l}`):p>=60?(g=`score-badge--mythic`,_=`Mythic Match (${p}%)`):p>=55?(g=`score-badge--legendary`,_=`Peak Match (${p}%)`):p>=50?(g=`score-badge--epic`,_=`Top Match (${p}%)`):p>=45?(g=`score-badge--rare`,_=`Strong Match (${p}%)`):p>=40?(g=`score-badge--good`,_=`Good Match (${p}%)`):(g=`score-badge--fair`,_=`Similar Style (${p}%)`);let v=a||!s?`https://placehold.co/460x215/151c2b/94a3b8?text=${encodeURIComponent(c.slice(0,16))}`:ei(s);return(0,M.jsxs)(`article`,{className:`game-card-tactile`,children:[(0,M.jsxs)(`div`,{className:`game-card-cover-wrap`,children:[(0,M.jsx)(`img`,{src:v,alt:c,className:`game-card-cover-img`,loading:`lazy`,onError:()=>o(!0)}),!r&&(p!=null||l>0)&&(0,M.jsxs)(`div`,{className:`game-card-score-badge ${g}`,title:_,children:[(0,M.jsx)(`span`,{children:p==null?l:`${p}%`}),(0,M.jsx)(`span`,{style:{fontSize:`0.65rem`,opacity:.85},children:p==null?`pts`:`match`})]}),(0,M.jsxs)(`div`,{className:`game-card-badges-left`,children:[u&&(0,M.jsxs)(`span`,{className:`badge-mature`,children:[(0,M.jsx)(Ir,{size:12,style:{display:`inline`,verticalAlign:`text-top`,marginInlineEnd:`3px`}}),i(`mature_warning`)]}),d&&f&&(0,M.jsxs)(Mn,{to:`/series?id=${f}`,className:`badge-series`,title:i(`view_series`),onClick:e=>e.stopPropagation(),children:[(0,M.jsx)(Cr,{size:12}),(0,M.jsx)(`span`,{children:i(`view_series`)})]})]})]}),(0,M.jsxs)(`div`,{className:`game-card-body`,children:[(0,M.jsx)(`h3`,{className:`game-card-title`,title:c,children:c}),m.length>0&&(0,M.jsx)(`div`,{className:`game-card-tags`,children:m.slice(0,3).map((e,t)=>(0,M.jsx)(`span`,{className:`game-tag-pill`,children:e},t))}),(0,M.jsxs)(`div`,{className:`game-card-actions-layout`,children:[s&&(0,M.jsxs)(`button`,{type:`button`,className:`btn btn-ai card-ai-action-btn`,onClick:()=>n(s,c),title:i(`ai_summary_btn`),children:[(0,M.jsx)(Rr,{size:14}),(0,M.jsx)(`span`,{children:i(`ai_summary_btn`)})]}),(0,M.jsxs)(`div`,{className:`card-secondary-actions-row`,children:[s&&(0,M.jsxs)(`a`,{href:`https://store.steampowered.com/app/${s}`,target:`_blank`,rel:`noopener noreferrer`,className:`btn btn-steam-prominent`,title:i(`view_steam`),children:[(0,M.jsx)(Sr,{size:14}),(0,M.jsx)(`span`,{children:i(`view_steam`)})]}),(0,M.jsxs)(`button`,{type:`button`,className:`btn btn-secondary card-similar-btn`,onClick:()=>t(c),title:i(`find_similar`),children:[(0,M.jsx)(jr,{size:14}),(0,M.jsx)(`span`,{children:i(`find_similar`)})]})]})]})]}),(0,M.jsx)(`style`,{children:`
      ...
      `})]})},mi=({variant:e=`card`,count:t=1})=>{let n=Array.from({length:t});return e===`target`?(0,M.jsxs)(`div`,{className:`skeleton-target-card`,children:[(0,M.jsx)(`div`,{className:`skeleton skeleton-target-image`}),(0,M.jsxs)(`div`,{className:`skeleton-target-content`,children:[(0,M.jsx)(`div`,{className:`skeleton skeleton-pill`,style:{width:`120px`,height:`24px`}}),(0,M.jsx)(`div`,{className:`skeleton skeleton-title`,style:{width:`65%`,height:`36px`}}),(0,M.jsxs)(`div`,{className:`skeleton-target-actions`,children:[(0,M.jsx)(`div`,{className:`skeleton skeleton-btn`,style:{width:`180px`,height:`42px`}}),(0,M.jsx)(`div`,{className:`skeleton skeleton-btn`,style:{width:`140px`,height:`42px`}})]})]}),(0,M.jsx)(`style`,{children:`
        ...
        `})]}):e===`timeline-item`?(0,M.jsxs)(`div`,{className:`skeleton-timeline-container`,children:[n.map((e,t)=>(0,M.jsxs)(`div`,{className:`skeleton-timeline-row`,children:[(0,M.jsx)(`div`,{className:`skeleton skeleton-timeline-node`}),(0,M.jsxs)(`div`,{className:`skeleton-timeline-card`,children:[(0,M.jsx)(`div`,{className:`skeleton skeleton-timeline-img`}),(0,M.jsxs)(`div`,{className:`skeleton-timeline-meta`,children:[(0,M.jsx)(`div`,{className:`skeleton skeleton-title`,style:{width:`50%`,height:`20px`}}),(0,M.jsx)(`div`,{className:`skeleton skeleton-text`,style:{width:`30%`,height:`14px`}})]})]})]},t)),(0,M.jsx)(`style`,{children:`
        ...
        `})]}):e===`feedback`?(0,M.jsxs)(`div`,{className:`skeleton-feedback-grid`,children:[n.map((e,t)=>(0,M.jsxs)(`div`,{className:`skeleton-feedback-card`,children:[(0,M.jsxs)(`div`,{className:`skeleton-feedback-top`,children:[(0,M.jsx)(`div`,{className:`skeleton skeleton-stars`,style:{width:`90px`,height:`16px`}}),(0,M.jsx)(`div`,{className:`skeleton skeleton-date`,style:{width:`70px`,height:`14px`}})]}),(0,M.jsx)(`div`,{className:`skeleton skeleton-text`,style:{width:`95%`,height:`16px`,marginTop:`0.75rem`}}),(0,M.jsx)(`div`,{className:`skeleton skeleton-text`,style:{width:`75%`,height:`16px`,marginTop:`0.4rem`}}),(0,M.jsx)(`div`,{className:`skeleton skeleton-author`,style:{width:`80px`,height:`14px`,marginTop:`1rem`}})]},t)),(0,M.jsx)(`style`,{children:`
        ...
        `})]}):(0,M.jsxs)(`div`,{className:`skeleton-cards-grid`,children:[n.map((e,t)=>(0,M.jsxs)(`div`,{className:`skeleton-game-card`,children:[(0,M.jsx)(`div`,{className:`skeleton skeleton-card-cover`}),(0,M.jsxs)(`div`,{className:`skeleton-card-body`,children:[(0,M.jsx)(`div`,{className:`skeleton skeleton-title`,style:{width:`70%`,height:`22px`}}),(0,M.jsxs)(`div`,{className:`skeleton-tags-row`,children:[(0,M.jsx)(`div`,{className:`skeleton skeleton-tag`,style:{width:`45px`,height:`18px`}}),(0,M.jsx)(`div`,{className:`skeleton-tag`,style:{width:`60px`,height:`18px`}}),(0,M.jsx)(`div`,{className:`skeleton-tag`,style:{width:`50px`,height:`18px`}})]}),(0,M.jsxs)(`div`,{className:`skeleton-card-actions`,children:[(0,M.jsx)(`div`,{className:`skeleton skeleton-btn`,style:{flex:1,height:`34px`}}),(0,M.jsx)(`div`,{className:`skeleton skeleton-btn`,style:{flex:1,height:`34px`}})]})]})]},t)),(0,M.jsx)(`style`,{children:`
        .skeleton-cards-grid {
          display: grid;
          grid-template-columns: repeat(auto-fill, minmax(280px, 1fr));
          gap: 1.5rem;
      ...
      `})]})},hi=({searches:e,onSelect:t,onRemove:n,onClear:r,isVisible:i})=>{let{t:a}=Xn();return!i||!e||e.length===0?null:(0,M.jsxs)(`div`,{className:`recent-searches-root`,children:[(0,M.jsxs)(`div`,{className:`recent-searches-header`,children:[(0,M.jsxs)(`div`,{className:`recent-title-group`,children:[(0,M.jsx)(Mr,{size:14,color:`var(--accent-amber)`}),(0,M.jsx)(`span`,{children:a(`recent_searches_title`)})]}),(0,M.jsx)(`button`,{type:`button`,className:`recent-clear-btn`,onClick:e=>{e.stopPropagation(),r()},children:a(`clear_recent`)})]}),(0,M.jsx)(`div`,{className:`recent-searches-list`,children:e.map((e,r)=>(0,M.jsxs)(`div`,{className:`recent-search-item`,onMouseDown:()=>t(e),children:[(0,M.jsxs)(`div`,{className:`recent-item-text`,children:[(0,M.jsx)(Rr,{size:13,className:`recent-item-sparkle`}),(0,M.jsx)(`span`,{children:e})]}),(0,M.jsx)(`button`,{type:`button`,className:`recent-item-remove`,onClick:t=>{t.stopPropagation(),n(e)},title:`Remove`,children:(0,M.jsx)(Wr,{size:13})})]},r))}),(0,M.jsx)(`style`,{children:`
      ...
      `})]})},gi=({appId:e,gameTitle:t,isOpen:n,onClose:r})=>{let{t:i,lang:a}=Xn(),[o,s]=(0,x.useState)(!0),[c,l]=(0,x.useState)(null),[u,d]=(0,x.useState)(null);if((0,x.useEffect)(()=>{if(!n||!e)return;let t=!0;return s(!0),l(null),d(null),oi(e,a).then(e=>{t&&(d(e),s(!1))}).catch(e=>{t&&(l(e.message||`Failed to load summary`),s(!1))}),()=>{t=!1}},[n,e,a]),!n)return null;let f=u?(e=>{if(!e)return{general:[],pros:[],cons:[]};let t=e.split(`
`).map(e=>e.trim()).filter(Boolean),n=[],r=[],i=[],a=`general`;return t.forEach(e=>{let t=e.toLowerCase(),o=e.replace(/^[*\-•\d.]+\s*/,``).trim();if(t.includes(`pros`)||t.includes(`الايجابيات`)||t.includes(`المميزات`)||t.includes(`highlights`)||t.includes(`strengths`)){a=`pros`;return}if(t.includes(`cons`)||t.includes(`السلبيات`)||t.includes(`العيوب`)||t.includes(`criticisms`)||t.includes(`weaknesses`)){a=`cons`;return}o&&(a===`pros`?r.push(o):a===`cons`?i.push(o):n.push(o))}),{general:n,pros:r,cons:i}})(u.Summary||u.summary):null,p=(u?.Source||u?.source||``).toLowerCase().includes(`cache`);return(0,Kr.createPortal)((0,M.jsxs)(`div`,{className:`modal-backdrop`,onClick:r,children:[(0,M.jsxs)(`div`,{className:`modal-surface ai-modal-container`,onClick:e=>e.stopPropagation(),children:[(0,M.jsx)(`button`,{type:`button`,className:`modal-close-btn`,onClick:r,"aria-label":`Close modal`,children:(0,M.jsx)(Wr,{size:20})}),(0,M.jsxs)(`div`,{className:`ai-modal-header`,children:[(0,M.jsx)(`div`,{className:`ai-modal-icon-badge`,children:(0,M.jsx)(Rr,{size:22})}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h2`,{className:`ai-modal-title heading-display`,children:i(`ai_modal_title`)}),(0,M.jsx)(`p`,{className:`ai-modal-subtitle`,children:t})]})]}),(0,M.jsxs)(`div`,{className:`ai-modal-body`,children:[o&&(0,M.jsxs)(`div`,{className:`ai-loading-wrap`,children:[(0,M.jsx)(`div`,{className:`ai-pulsing-loader`,children:(0,M.jsx)(Rr,{size:28,className:`pulsing-sparkle`})}),(0,M.jsx)(`p`,{className:`ai-loading-text`,children:i(`ai_analyzing`)}),(0,M.jsxs)(`div`,{className:`skeleton-lines-group`,children:[(0,M.jsx)(`div`,{className:`skeleton skeleton-line`,style:{width:`90%`,height:`14px`}}),(0,M.jsx)(`div`,{className:`skeleton skeleton-line`,style:{width:`80%`,height:`14px`}}),(0,M.jsx)(`div`,{className:`skeleton skeleton-line`,style:{width:`60%`,height:`14px`}})]})]}),c&&(0,M.jsxs)(`div`,{className:`ai-error-box`,children:[(0,M.jsx)(Vr,{size:24,color:`var(--mature-red)`}),(0,M.jsx)(`p`,{children:c})]}),u&&f&&(0,M.jsxs)(`div`,{className:`ai-content-wrap`,children:[f.general.length>0&&(0,M.jsx)(`div`,{className:`ai-general-section`,children:f.general.map((e,t)=>(0,M.jsx)(`p`,{className:`ai-general-text`,children:e},t))}),f.pros.length>0&&(0,M.jsxs)(`div`,{className:`ai-bullet-group ai-pros-group`,children:[(0,M.jsxs)(`h3`,{className:`ai-bullet-header pros-header`,children:[(0,M.jsx)(_r,{size:18}),(0,M.jsx)(`span`,{children:i(`ai_pros`)})]}),(0,M.jsx)(`ul`,{className:`ai-bullet-list`,children:f.pros.map((e,t)=>(0,M.jsx)(`li`,{className:`ai-bullet-item pro-item`,children:e},t))})]}),f.cons.length>0&&(0,M.jsxs)(`div`,{className:`ai-bullet-group ai-cons-group`,children:[(0,M.jsxs)(`h3`,{className:`ai-bullet-header cons-header`,children:[(0,M.jsx)(Vr,{size:18}),(0,M.jsx)(`span`,{children:i(`ai_cons`)})]}),(0,M.jsx)(`ul`,{className:`ai-bullet-list`,children:f.cons.map((e,t)=>(0,M.jsx)(`li`,{className:`ai-bullet-item con-item`,children:e},t))})]}),(0,M.jsx)(`div`,{className:`ai-source-footer`,children:(0,M.jsxs)(`div`,{className:`ai-source-tag`,children:[p?(0,M.jsx)(xr,{size:13}):(0,M.jsx)(br,{size:13}),(0,M.jsx)(`span`,{children:i(p?`ai_source_cache`:`ai_source_groq`)})]})})]})]})]}),(0,M.jsx)(`style`,{children:`
        .ai-modal-container {
          max-width: 640px;
        }
      ...
      `})]}),document.body)},_i=()=>{let{t:e}=Xn(),[t,n]=Rn(),{recentSearches:r,addSearch:i,removeSearch:a,clearSearches:o}=Qr(),[s,c]=(0,x.useState)(`single`),[l,u]=(0,x.useState)([]),[d,f]=(0,x.useState)(t.get(`search`)||``),[p,m]=(0,x.useState)([]),[h,g]=(0,x.useState)(!1),[_,v]=(0,x.useState)(!1),[y,b]=(0,x.useState)(!1),[ee,S]=(0,x.useState)(null),[C,w]=(0,x.useState)(null),[te,ne]=(0,x.useState)(null),[T,E]=(0,x.useState)(``),[re,ie]=(0,x.useState)(!1),ae=(0,x.useRef)(null),oe=(0,x.useRef)(null);(0,x.useEffect)(()=>{let e=t.get(`search`);e&&e.trim()&&s===`single`&&(f(e),ce(e))},[t]),(0,x.useEffect)(()=>{let e=e=>{ae.current&&!ae.current.contains(e.target)&&(g(!1),v(!1))};return document.addEventListener(`mousedown`,e),()=>document.removeEventListener(`mousedown`,e)},[]);let se=e=>{let t=e.target.value;f(t),oe.current&&clearTimeout(oe.current),t.trim().length>=1?oe.current=setTimeout(async()=>{try{let e=await ni(t);m(e),g(!0)}catch{m([])}},200):(m([]),g(!1))},ce=async e=>{let t=e.trim();if(t){g(!1),v(!1),b(!0),S(null),w(null),n({search:t}),i(t);try{let e=await ti(t);w(e),b(!1)}catch(e){S(e.message||`Game not found`),b(!1)}}},D=async()=>{if(l.length!==0){g(!1),v(!1),b(!0),S(null),w(null);try{let e=await ri(l);w(e),b(!1)}catch(e){S(e.message||`Failed to blend games`),b(!1)}}},O=e=>{e.preventDefault(),s===`blend`?d.trim()&&l.length<4?(u([...l,d.trim()]),f(``)):l.length>0&&D():ce(d)},le=e=>{s===`blend`?(l.length<4&&!l.includes(e)&&u([...l,e]),f(``),g(!1)):(f(e),ce(e))},ue=e=>{u(l.filter((t,n)=>n!==e))},de=(e,t)=>{ne(e),E(t),ie(!0)},fe=C?.Recommendations||C?.recommendations||[],k=C?.TargetGames||C?.targetGames||[];return(0,M.jsxs)(`div`,{className:`home-root`,children:[(0,M.jsxs)(`section`,{className:`home-hero`,children:[(0,M.jsxs)(`div`,{className:`hero-badge`,children:[(0,M.jsx)(Rr,{size:14}),(0,M.jsx)(`span`,{children:e(`hero_badge`)})]}),(0,M.jsxs)(`h1`,{className:`hero-title heading-display`,children:[e(`hero_title_prefix`),` `,(0,M.jsx)(`span`,{className:`highlight-amber`,children:e(`hero_title_highlight`)})]}),(0,M.jsx)(`p`,{className:`hero-subtitle`,children:e(`hero_subtitle`)}),(0,M.jsxs)(`div`,{className:`search-mode-tabs`,children:[(0,M.jsxs)(`button`,{type:`button`,className:`mode-tab-btn ${s===`single`?`mode-tab-btn--active`:``}`,onClick:()=>{c(`single`),w(null)},children:[(0,M.jsx)(yr,{size:15}),(0,M.jsx)(`span`,{children:`Single Game Search`})]}),(0,M.jsxs)(`button`,{type:`button`,className:`mode-tab-btn ${s===`blend`?`mode-tab-btn--active`:``}`,onClick:()=>{c(`blend`),w(null)},children:[(0,M.jsx)(Er,{size:15}),(0,M.jsx)(`span`,{children:e(`blend_mode_label`)})]})]}),(0,M.jsxs)(`div`,{className:`search-bar-wrapper`,ref:ae,children:[s===`blend`&&(0,M.jsxs)(`div`,{className:`blend-chips-container`,children:[l.map((t,n)=>(0,M.jsxs)(`span`,{className:`blend-chip`,children:[(0,M.jsx)(`span`,{children:t}),(0,M.jsx)(`button`,{type:`button`,className:`blend-chip-remove`,onClick:()=>ue(n),title:e(`blend_remove`),children:(0,M.jsx)(Wr,{size:12})})]},n)),l.length<4&&(0,M.jsx)(`span`,{className:`blend-chips-hint`,children:l.length===0?e(`blend_mode_hint`):`(${l.length}/4)`})]}),(0,M.jsxs)(`form`,{className:`search-form`,onSubmit:O,children:[(0,M.jsx)(Nr,{size:20,className:`search-icon-inside`}),(0,M.jsx)(`input`,{type:`text`,className:`search-input`,value:d,onChange:se,onFocus:()=>v(!0),placeholder:e(s===`blend`?`blend_add_placeholder`:`search_placeholder`),autoComplete:`off`}),s===`blend`?(0,M.jsxs)(`div`,{className:`blend-form-actions`,children:[d.trim()&&l.length<4&&(0,M.jsxs)(`button`,{type:`button`,className:`btn btn-secondary blend-add-btn`,onClick:()=>{d.trim()&&(u([...l,d.trim()]),f(``))},children:[(0,M.jsx)(Ar,{size:15}),(0,M.jsx)(`span`,{children:`Add`})]}),(0,M.jsxs)(`button`,{type:`button`,className:`btn btn-primary search-submit-btn`,disabled:l.length===0&&!d.trim(),onClick:()=>{if(d.trim()&&l.length<4&&!l.includes(d.trim())){let e=[...l,d.trim()];u(e),f(``),ri(e).then(e=>{w(e),b(!1)}).catch(e=>{S(e.message),b(!1)})}else D()},children:[(0,M.jsx)(Er,{size:15}),(0,M.jsx)(`span`,{children:e(`blend_btn`)})]})]}):(0,M.jsx)(`button`,{type:`submit`,className:`btn btn-primary search-submit-btn`,children:(0,M.jsx)(`span`,{children:e(`search_btn`)})})]}),h&&p.length>0&&(0,M.jsx)(`div`,{className:`autocomplete-dropdown`,children:p.map((e,t)=>(0,M.jsxs)(`div`,{className:`autocomplete-item`,onMouseDown:()=>le(e.name||e.Name),children:[(0,M.jsx)(yr,{size:14,className:`autocomplete-icon`}),(0,M.jsx)(`span`,{className:`autocomplete-name`,children:e.name||e.Name})]},t))}),s===`single`&&(0,M.jsx)(hi,{searches:r,isVisible:_&&d.trim().length<2&&!h,onSelect:e=>{f(e),ce(e)},onRemove:a,onClear:o})]})]}),y&&(0,M.jsxs)(`div`,{className:`results-loading-section`,children:[(0,M.jsxs)(`div`,{className:`loading-status-bar`,children:[(0,M.jsx)(jr,{size:18,className:`spin-icon`}),(0,M.jsx)(`span`,{children:e(`loading_searching`)})]}),(0,M.jsx)(mi,{variant:`target`}),(0,M.jsx)(mi,{variant:`card`,count:8})]}),ee&&!y&&(0,M.jsxs)(`div`,{className:`error-state-card`,children:[(0,M.jsx)(`div`,{className:`error-icon-box`,children:(0,M.jsx)(gr,{size:32})}),(0,M.jsx)(`h3`,{className:`error-title heading-display`,children:e(`error_not_found_title`)}),(0,M.jsx)(`p`,{className:`error-desc`,children:e(`error_not_found_desc`)}),(0,M.jsxs)(`button`,{type:`button`,className:`btn btn-secondary`,onClick:()=>s===`blend`?D():ce(d),children:[(0,M.jsx)(jr,{size:16}),(0,M.jsx)(`span`,{children:e(`try_again`)})]})]}),C&&!y&&(0,M.jsxs)(`div`,{className:`results-view-section`,children:[s===`blend`||k.length>0?(0,M.jsxs)(`div`,{className:`blended-target-spotlight`,children:[(0,M.jsxs)(`div`,{className:`blended-spotlight-header`,children:[(0,M.jsx)(`div`,{className:`blended-icon-box`,children:(0,M.jsx)(Er,{size:22})}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`span`,{className:`badge badge-amber`,children:e(`blend_target_title`)}),(0,M.jsx)(`h2`,{className:`blended-title heading-display`,children:e(`blend_selected_games`)})]})]}),(0,M.jsx)(`div`,{className:`blended-games-pills`,children:(k.length>0?k:l.map(e=>({Name:e}))).map((e,t)=>(0,M.jsxs)(`span`,{className:`blended-target-pill`,children:[(0,M.jsx)(yr,{size:14,color:`var(--accent-amber)`}),(0,M.jsx)(`span`,{children:e.Name||e.name||e})]},t))})]}):(0,M.jsx)(fi,{targetGameName:C.TargetGame||C.targetGame||d,targetAppId:C.TargetAppId||C.targetAppId,hasSeries:C.HasSeries||C.hasSeries,seriesId:C.SeriesId||C.seriesId,onOpenAiSummary:de}),(0,M.jsx)(`div`,{className:`recommendations-header`,children:(0,M.jsxs)(`div`,{className:`rec-title-group`,style:{display:`flex`,alignItems:`center`,flexWrap:`wrap`,gap:`0.6rem`},children:[(0,M.jsx)(`h3`,{className:`rec-section-title heading-display`,children:e(`recommendations_title`)}),(0,M.jsxs)(`span`,{className:`rec-count-badge`,children:[fe.length,` `,e(`recommendations_count`)]}),(C?.Source===`machine_learning`||C?.source===`machine_learning`)&&(0,M.jsxs)(`span`,{className:`badge-engine badge-engine--ml`,style:{display:`inline-flex`,alignItems:`center`,gap:`5px`,padding:`4px 10px`,borderRadius:`20px`,fontSize:`0.75rem`,fontWeight:`700`,background:`linear-gradient(135deg, rgba(99, 102, 241, 0.25), rgba(168, 85, 247, 0.25))`,color:`#c084fc`,border:`1px solid rgba(168, 85, 247, 0.4)`,letterSpacing:`0.02em`},children:[(0,M.jsx)(Rr,{size:13}),(0,M.jsx)(`span`,{children:`ML Neural Engine`})]}),(C?.Source===`heuristic`||C?.source===`heuristic`)&&(0,M.jsxs)(`span`,{className:`badge-engine badge-engine--heuristic`,style:{display:`inline-flex`,alignItems:`center`,gap:`5px`,padding:`4px 10px`,borderRadius:`20px`,fontSize:`0.75rem`,fontWeight:`600`,background:`rgba(255, 255, 255, 0.08)`,color:`#94a3b8`,border:`1px solid rgba(255, 255, 255, 0.15)`},children:[(0,M.jsx)(yr,{size:13}),(0,M.jsx)(`span`,{children:`Smart Tag Matching`})]})]})}),(0,M.jsx)(`div`,{className:`recommendations-grid`,children:fe.map((e,t)=>(0,M.jsx)(pi,{game:e,onSelectSimilar:e=>{s===`blend`?l.length<4&&!l.includes(e)&&u([...l,e]):(f(e),ce(e))},onOpenAiSummary:de},e.appid||e.Appid||t))})]}),(0,M.jsx)(gi,{appId:te,gameTitle:T,isOpen:re,onClose:()=>ie(!1)}),(0,M.jsx)(`style`,{children:`
        .home-root {
          display: flex;
          flex-direction: column;
        }
      ...
      `})]})},vi=()=>{let{t:e,isRTL:t}=Xn(),[n,r]=Rn(),i=n.get(`id`),[a,o]=(0,x.useState)(``),[s,c]=(0,x.useState)([]),[l,u]=(0,x.useState)(!1),[d,f]=(0,x.useState)(!0),[p,m]=(0,x.useState)(!1),[h,g]=(0,x.useState)(null),[_,v]=(0,x.useState)(null),y=(0,x.useRef)(null),b=(0,x.useRef)(null);(0,x.useEffect)(()=>{i?S(i,d):(v(null),g(null))},[i,d]),(0,x.useEffect)(()=>{let e=e=>{b.current&&!b.current.contains(e.target)&&u(!1)};return document.addEventListener(`mousedown`,e),()=>document.removeEventListener(`mousedown`,e)},[]);let ee=e=>{let t=e.target.value;o(t),y.current&&clearTimeout(y.current),t.trim().length>=2?y.current=setTimeout(async()=>{try{let e=await ci(t);c(e),u(!0)}catch{c([])}},250):(c([]),u(!1))},S=async(e,t)=>{m(!0),g(null);try{let n=await si(e,t);v(n),m(!1)}catch(e){g(e.message||`Failed to load timeline`),m(!1)}},C=e=>{let t=e.id||e.Id,n=e.name||e.Name;o(n),u(!1),r({id:t})},w=_?.Timeline||_?.timeline||[],te=_?.SeriesName||_?.seriesName||``;return(0,M.jsxs)(`div`,{className:`series-page-root`,children:[(0,M.jsxs)(`section`,{className:`series-hero`,children:[(0,M.jsxs)(`div`,{className:`hero-badge`,children:[(0,M.jsx)(Cr,{size:14}),(0,M.jsx)(`span`,{children:e(`series_hero_badge`)})]}),(0,M.jsxs)(`h1`,{className:`hero-title heading-display`,children:[e(`series_title_prefix`),` `,(0,M.jsx)(`span`,{className:`highlight-amber`,children:e(`series_title_highlight`)})]}),(0,M.jsx)(`p`,{className:`hero-subtitle`,children:e(`series_subtitle`)}),(0,M.jsxs)(`div`,{className:`series-search-container`,ref:b,children:[(0,M.jsxs)(`div`,{className:`series-search-box`,children:[(0,M.jsx)(Nr,{size:19,className:`search-icon-inside`}),(0,M.jsx)(`input`,{type:`text`,className:`series-search-input`,value:a,onChange:ee,placeholder:e(`series_search_placeholder`),autoComplete:`off`})]}),l&&s.length>0&&(0,M.jsx)(`div`,{className:`series-autocomplete-list`,children:s.map((e,t)=>(0,M.jsxs)(`div`,{className:`series-autocomplete-item`,onMouseDown:()=>C(e),children:[(0,M.jsx)(Cr,{size:15,color:`var(--accent-amber)`}),(0,M.jsx)(`span`,{children:e.name||e.Name})]},t))})]})]}),(0,M.jsxs)(`div`,{className:`series-content-area`,children:[p&&(0,M.jsx)(`div`,{className:`timeline-loading-wrap`,children:(0,M.jsx)(mi,{variant:`timeline-item`,count:5})}),h&&!p&&(0,M.jsxs)(`div`,{className:`error-state-card`,children:[(0,M.jsx)(`div`,{className:`error-icon-box`,children:(0,M.jsx)(gr,{size:32})}),(0,M.jsx)(`h3`,{className:`error-title heading-display`,children:e(`error_generic`)}),(0,M.jsx)(`p`,{className:`error-desc`,children:h})]}),!i&&!p&&!h&&(0,M.jsxs)(`div`,{className:`series-empty-state`,children:[(0,M.jsx)(`div`,{className:`empty-icon-circle`,children:(0,M.jsx)(Cr,{size:36})}),(0,M.jsx)(`h3`,{className:`empty-title heading-display`,children:e(`series_empty_title`)}),(0,M.jsx)(`p`,{className:`empty-desc`,children:e(`series_empty_desc`)}),(0,M.jsx)(`div`,{className:`popular-series-pills`,children:[`Resident Evil`,`Dark Souls`,`Assassin's Creed`,`God of War`,`Final Fantasy`,`Yakuza`].map(e=>(0,M.jsx)(`button`,{type:`button`,className:`series-quick-pill`,onClick:async()=>{o(e);let t=await ci(e);t&&t.length>0&&C(t[0])},children:(0,M.jsx)(`span`,{children:e})},e))})]}),_&&!p&&!h&&(0,M.jsxs)(`div`,{className:`timeline-section`,children:[(0,M.jsxs)(`div`,{className:`timeline-toolbar`,children:[(0,M.jsxs)(`div`,{className:`timeline-series-title-wrap`,children:[(0,M.jsx)(`span`,{className:`timeline-franchise-label`,children:e(`nav_series`)}),(0,M.jsxs)(`h2`,{className:`timeline-series-title heading-display`,children:[te,` `,(0,M.jsx)(`span`,{className:`highlight-amber`,children:`Timeline`})]})]}),(0,M.jsxs)(`label`,{className:`mainline-toggle-box`,children:[(0,M.jsx)(`input`,{type:`checkbox`,checked:d,onChange:e=>f(e.target.checked),className:`toggle-checkbox`}),(0,M.jsx)(`span`,{className:`toggle-slider`}),(0,M.jsx)(`span`,{className:`toggle-text`,children:e(`mainline_toggle_label`)})]})]}),(0,M.jsxs)(`div`,{className:`timeline-tree`,children:[(0,M.jsx)(`div`,{className:`timeline-spine-line`}),w.map((n,r)=>{let i=n.IsMainline??n.isMainline,a=n.ReleaseDate||n.releaseDate,o=n.CoverImageUrl||n.coverImageUrl,s=n.Title||n.title,c=n.ChronologicalOrder??n.chronologicalOrder??r+1;return(0,M.jsxs)(`div`,{className:`timeline-entry`,style:{animationDelay:`${r*80}ms`},children:[(0,M.jsx)(`div`,{className:`timeline-node-marker`,children:(0,M.jsx)(`span`,{children:c})}),(0,M.jsxs)(`div`,{className:`timeline-entry-card`,children:[(0,M.jsx)(`div`,{className:`timeline-card-image-wrap`,children:o?(0,M.jsx)(`img`,{src:o,alt:s,className:`timeline-card-image`,loading:`lazy`,onError:e=>{e.target.src=`https://placehold.co/140x90/151c2b/94a3b8?text=${encodeURIComponent(s.slice(0,10))}`}}):(0,M.jsx)(`div`,{className:`timeline-card-image-fallback`,children:(0,M.jsx)(`span`,{children:s.slice(0,2)})})}),(0,M.jsxs)(`div`,{className:`timeline-card-details`,children:[(0,M.jsxs)(`div`,{className:`timeline-badges-row`,children:[(0,M.jsx)(`span`,{className:`timeline-badge ${i?`timeline-badge--mainline`:`timeline-badge--spinoff`}`,children:e(i?`mainline_badge`:`spinoff_badge`)}),a&&(0,M.jsxs)(`span`,{className:`timeline-date-tag`,children:[(0,M.jsx)(cr,{size:12}),(0,M.jsx)(`span`,{children:a})]})]}),(0,M.jsx)(`h4`,{className:`timeline-game-title heading-display`,children:s}),(0,M.jsx)(`div`,{className:`timeline-actions`,children:(0,M.jsxs)(Mn,{to:`/?search=${encodeURIComponent(s)}`,className:`btn btn-ghost timeline-similar-link`,children:[(0,M.jsx)(`span`,{children:e(`find_similar`)}),t?(0,M.jsx)(or,{size:13}):(0,M.jsx)(sr,{size:13})]})})]})]})]},n.Id||n.id||r)})]})]})]}),(0,M.jsx)(`style`,{children:`
        .series-page-root {
          display: flex;
          flex-direction: column;
        }
      ...
      `})]})},yi=()=>{let{t:e,isRTL:t}=Xn(),n=bt(),[r,i]=(0,x.useState)([]),[a,o]=(0,x.useState)(0),[s,c]=(0,x.useState)(``),[l,u]=(0,x.useState)(null),[d,f]=(0,x.useState)(!1),[p,m]=(0,x.useState)(1),[h,g]=(0,x.useState)(24),[_,v]=(0,x.useState)(!0),[y,b]=(0,x.useState)(null),[ee,S]=(0,x.useState)(null),[C,w]=(0,x.useState)(``),[te,ne]=(0,x.useState)(!1),T=(0,x.useRef)(null);(0,x.useEffect)(()=>{ii().then(e=>{let t=e.Games||e.games||[];i(t),o(e.TotalSavedGames||e.totalSavedGames||t.length),v(!1)}).catch(e=>{b(e.message||`Failed to load game library`),v(!1)})},[]),(0,x.useEffect)(()=>{let e=()=>{ai().then(e=>{u(e),e.TotalGamesInDatabase&&o(e.TotalGamesInDatabase)}).catch(()=>{})};e();let t=setInterval(e,3500);return()=>clearInterval(t)},[]);let E=(0,x.useMemo)(()=>{if(!s.trim())return r;let e=s.toLowerCase().trim();return r.filter(t=>(t.name||t.Name||``).toLowerCase().includes(e))},[r,s]);(0,x.useEffect)(()=>{m(1)},[s,h]);let re=Math.ceil(E.length/h)||1,ie=(p-1)*h,ae=Math.min(ie+h,E.length),oe=E.slice(ie,ae),se=e=>{e>=1&&e<=re&&e!==p&&(m(e),T.current&&T.current.scrollIntoView({behavior:`smooth`,block:`start`}))},ce=()=>{let e=[],t=Math.max(1,p-2),n=Math.min(re,t+5-1);n-t<4&&(t=Math.max(1,n-5+1));for(let r=t;r<=n;r++)e.push(r);return e},D=(e,t)=>{S(e),w(t),ne(!0)};return(0,M.jsxs)(`div`,{className:`library-page-root`,children:[(0,M.jsxs)(`section`,{className:`library-hero`,children:[(0,M.jsxs)(`div`,{className:`hero-badge`,children:[(0,M.jsx)(xr,{size:14}),(0,M.jsx)(`span`,{children:e(`library_hero_badge`)})]}),(0,M.jsxs)(`h1`,{className:`hero-title heading-display`,children:[e(`library_title_prefix`),` `,(0,M.jsx)(`span`,{className:`highlight-amber`,children:e(`library_title_highlight`)})]}),(0,M.jsx)(`p`,{className:`hero-subtitle`,children:e(`library_subtitle`)}),l&&(0,M.jsxs)(`div`,{className:`live-monitor-card`,children:[(0,M.jsxs)(`div`,{className:`live-monitor-header`,onClick:()=>f(!d),children:[(0,M.jsxs)(`div`,{className:`live-monitor-status-cluster`,children:[(0,M.jsx)(`span`,{className:`status-dot ${l.IsSeedingRunning?`status-dot--active`:`status-dot--idle`}`}),(0,M.jsx)(`span`,{className:`status-label`,children:l.IsSeedingRunning?`جاري السحب والتحليل (صفحة ${l.CurrentPage}) : ${l.CurrentGame||`فحص...`}`:`السحب في الخلفية جاهز / متوقف مؤقتاً`}),l.AddedInCurrentPage>0&&(0,M.jsxs)(`span`,{className:`added-badge`,children:[`+`,l.AddedInCurrentPage,` لعبة جديدة بالصفحة`]})]}),(0,M.jsxs)(`div`,{className:`live-monitor-actions`,children:[(0,M.jsxs)(`div`,{className:`total-live-badge`,children:[(0,M.jsx)(xr,{size:13}),(0,M.jsxs)(`span`,{children:[l.TotalGamesInDatabase.toLocaleString(),` لعبة مسجلة`]})]}),(0,M.jsxs)(`button`,{type:`button`,className:`toggle-logs-btn`,children:[(0,M.jsx)(Br,{size:14}),(0,M.jsx)(`span`,{children:d?`إخفاء الـ Logs`:`عرض الـ Logs`}),d?(0,M.jsx)(pr,{size:14}):(0,M.jsx)(ur,{size:14})]})]})]}),d&&(0,M.jsxs)(`div`,{className:`live-logs-terminal`,children:[(0,M.jsxs)(`div`,{className:`logs-terminal-title`,children:[(0,M.jsx)(Br,{size:12}),(0,M.jsx)(`span`,{children:`Live Seeding Activity Logs (Real-Time)`})]}),(0,M.jsx)(`div`,{className:`logs-list-scroll`,children:l.RecentLogs&&l.RecentLogs.length>0?l.RecentLogs.map((e,t)=>(0,M.jsx)(`div`,{className:`log-entry-line`,children:e},t)):(0,M.jsx)(`div`,{className:`log-entry-line muted`,children:`لا توجد عمليات مسجلة حتى الآن.`})})]})]}),(0,M.jsxs)(`div`,{className:`library-toolbar`,children:[(0,M.jsxs)(`div`,{className:`library-search-box`,children:[(0,M.jsx)(Nr,{size:19,className:`search-icon-inside`}),(0,M.jsx)(`input`,{type:`text`,className:`library-search-input`,value:s,onChange:e=>c(e.target.value),placeholder:e(`library_search_placeholder`)})]}),(0,M.jsxs)(`div`,{className:`library-controls-group`,children:[(0,M.jsxs)(`div`,{className:`library-counter-badge`,children:[(0,M.jsxs)(`span`,{className:`counter-label`,children:[e(`total_games_label`),`:`]}),(0,M.jsx)(`span`,{className:`counter-value`,children:a.toLocaleString()})]}),(0,M.jsxs)(`div`,{className:`page-size-selector`,children:[(0,M.jsx)(Lr,{size:14,color:`var(--text-muted)`}),(0,M.jsxs)(`select`,{value:h,onChange:e=>g(Number(e.target.value)),className:`page-size-dropdown`,children:[(0,M.jsx)(`option`,{value:24,children:`24 / page`}),(0,M.jsx)(`option`,{value:48,children:`48 / page`}),(0,M.jsx)(`option`,{value:96,children:`96 / page`})]})]})]})]})]}),(0,M.jsxs)(`div`,{className:`library-content-container`,ref:T,children:[_&&(0,M.jsx)(mi,{variant:`card`,count:12}),y&&!_&&(0,M.jsxs)(`div`,{className:`error-state-card`,children:[(0,M.jsx)(`div`,{className:`error-icon-box`,children:(0,M.jsx)(gr,{size:32})}),(0,M.jsx)(`h3`,{className:`error-title heading-display`,children:e(`error_generic`)}),(0,M.jsx)(`p`,{className:`error-desc`,children:y})]}),!_&&!y&&E.length===0&&(0,M.jsxs)(`div`,{className:`library-empty-box`,children:[(0,M.jsx)(Nr,{size:36,color:`var(--text-muted)`}),(0,M.jsx)(`p`,{className:`empty-desc`,children:e(`library_no_match`)})]}),!_&&!y&&E.length>0&&(0,M.jsxs)(M.Fragment,{children:[(0,M.jsx)(`div`,{className:`library-pagination-summary`,children:(0,M.jsx)(`span`,{children:t?`عرض ${ie+1} - ${ae} من أصل ${E.length} لعبة`:`Showing ${ie+1} - ${ae} of ${E.length} games`})}),(0,M.jsx)(`div`,{className:`library-grid`,children:oe.map((e,t)=>(0,M.jsx)(pi,{game:e,isLibrary:!0,onSelectSimilar:e=>{n(`/?search=${encodeURIComponent(e)}`)},onOpenAiSummary:D},e.appid||e.appId||e.Appid||t))}),re>1&&(0,M.jsxs)(`div`,{className:`pagination-bar`,children:[(0,M.jsx)(`button`,{type:`button`,className:`pagination-btn pagination-nav-btn pagination-nav-first`,onClick:()=>se(1),disabled:p===1,title:`First Page`,children:t?(0,M.jsx)(hr,{size:17}):(0,M.jsx)(mr,{size:17})}),(0,M.jsx)(`button`,{type:`button`,className:`pagination-btn pagination-nav-btn`,onClick:()=>se(p-1),disabled:p===1,title:`Previous Page`,children:t?(0,M.jsx)(fr,{size:17}):(0,M.jsx)(dr,{size:17})}),(0,M.jsx)(`div`,{className:`pagination-pages-list`,children:ce().map(e=>(0,M.jsx)(`button`,{type:`button`,className:`pagination-btn ${e===p?`pagination-btn--active`:``}`,onClick:()=>se(e),children:e},e))}),(0,M.jsx)(`button`,{type:`button`,className:`pagination-btn pagination-nav-btn`,onClick:()=>se(p+1),disabled:p===re,title:`Next Page`,children:t?(0,M.jsx)(dr,{size:17}):(0,M.jsx)(fr,{size:17})}),(0,M.jsx)(`button`,{type:`button`,className:`pagination-btn pagination-nav-btn pagination-nav-last`,onClick:()=>se(re),disabled:p===re,title:`Last Page`,children:t?(0,M.jsx)(mr,{size:17}):(0,M.jsx)(hr,{size:17})})]})]})]}),(0,M.jsx)(gi,{appId:ee,gameTitle:C,isOpen:te,onClose:()=>ne(!1)}),(0,M.jsx)(`style`,{children:`
        .library-page-root {
          display: flex;
          flex-direction: column;
        }
      ...
      `})]})},bi=()=>{let{t:e,isRTL:t}=Xn(),[n,r]=(0,x.useState)(5),[i,a]=(0,x.useState)(0),[o,s]=(0,x.useState)(``),[c,l]=(0,x.useState)(!1),[u,d]=(0,x.useState)(!1),[f,p]=(0,x.useState)(null),[m,h]=(0,x.useState)([]),[g,_]=(0,x.useState)(!0),v=async()=>{try{let e=await li();h(Array.isArray(e)?e:[])}catch{h([])}finally{_(!1)}};(0,x.useEffect)(()=>{v()},[]);let y=async e=>{if(e.preventDefault(),o.trim()){l(!0),p(null);try{await ui(o,n),l(!1),d(!0),v()}catch(e){p(e.message||`Failed to submit feedback`),l(!1)}}},b=()=>{s(``),r(5),d(!1),p(null)},ee=e=>{if(!e)return``;try{return new Date(e).toLocaleDateString(t?`ar-EG`:`en-US`,{year:`numeric`,month:`short`,day:`numeric`})}catch{return e}};return(0,M.jsxs)(`div`,{className:`feedback-page-root`,children:[(0,M.jsxs)(`section`,{className:`feedback-hero`,children:[(0,M.jsxs)(`div`,{className:`hero-badge`,children:[(0,M.jsx)(kr,{size:14}),(0,M.jsx)(`span`,{children:e(`feedback_hero_badge`)})]}),(0,M.jsxs)(`h1`,{className:`hero-title heading-display`,children:[e(`feedback_title_prefix`),` `,(0,M.jsx)(`span`,{className:`highlight-amber`,children:e(`feedback_title_highlight`)})]}),(0,M.jsx)(`p`,{className:`hero-subtitle`,children:e(`feedback_subtitle`)})]}),(0,M.jsx)(`div`,{className:`feedback-card-container`,children:u?(0,M.jsxs)(`div`,{className:`feedback-success-state`,children:[(0,M.jsx)(`div`,{className:`success-icon-circle`,children:(0,M.jsx)(_r,{size:42})}),(0,M.jsx)(`h2`,{className:`success-title heading-display`,children:e(`feedback_success_title`)}),(0,M.jsx)(`p`,{className:`success-desc`,children:e(`feedback_success_desc`)}),(0,M.jsxs)(`button`,{type:`button`,className:`btn btn-secondary`,onClick:b,children:[(0,M.jsx)(Rr,{size:16}),(0,M.jsx)(`span`,{children:e(`feedback_send_another`)})]})]}):(0,M.jsxs)(`form`,{className:`feedback-form-surface`,onSubmit:y,children:[(0,M.jsxs)(`div`,{className:`form-group-box`,children:[(0,M.jsx)(`label`,{className:`form-label`,children:e(`feedback_rating_label`)}),(0,M.jsx)(`div`,{className:`star-rating-row`,children:[1,2,3,4,5].map(e=>{let t=e<=(i||n);return(0,M.jsx)(`button`,{type:`button`,className:`star-btn ${t?`star-btn--active`:``}`,onClick:()=>r(e),onMouseEnter:()=>a(e),onMouseLeave:()=>a(0),children:(0,M.jsx)(zr,{size:32,className:t?`star-filled`:`star-outline`,fill:t?`var(--accent-amber)`:`none`})},e)})})]}),(0,M.jsxs)(`div`,{className:`form-group-box`,children:[(0,M.jsx)(`label`,{className:`form-label`,htmlFor:`feedbackText`,children:e(`feedback_text_label`)}),(0,M.jsx)(`textarea`,{id:`feedbackText`,className:`feedback-textarea`,rows:4,value:o,onChange:e=>s(e.target.value),placeholder:e(`feedback_placeholder`),required:!0})]}),f&&(0,M.jsxs)(`div`,{className:`feedback-error-banner`,children:[(0,M.jsx)(gr,{size:18}),(0,M.jsx)(`span`,{children:f})]}),(0,M.jsxs)(`button`,{type:`submit`,className:`btn btn-primary feedback-submit-btn`,disabled:c||!o.trim(),children:[(0,M.jsx)(Pr,{size:16}),(0,M.jsx)(`span`,{children:e(c?`feedback_submitting`:`feedback_submit_btn`)})]})]})}),(g||m.length>0)&&(0,M.jsxs)(`section`,{className:`community-feedbacks-section`,children:[(0,M.jsxs)(`div`,{className:`community-header`,children:[(0,M.jsx)(`div`,{className:`community-badge-icon`,children:(0,M.jsx)(Or,{size:20})}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h2`,{className:`community-title heading-display`,children:e(`feedback_wall_title`)}),(0,M.jsx)(`p`,{className:`community-subtitle`,children:e(`feedback_wall_subtitle`)})]})]}),g?(0,M.jsx)(mi,{variant:`feedback`,count:3}):(0,M.jsx)(`div`,{className:`feedbacks-grid`,children:m.slice(0,3).map((e,t)=>{let n=e.Description||e.description||e.Message||e.message||``,r=e.Rating||e.rating||5,i=e.dateTime||e.DateTime||e.createdAt;return(0,M.jsxs)(`div`,{className:`feedback-item-card`,children:[(0,M.jsxs)(`div`,{className:`feedback-card-top`,children:[(0,M.jsx)(`div`,{className:`feedback-card-stars`,children:[1,2,3,4,5].map(e=>(0,M.jsx)(zr,{size:14,fill:e<=r?`var(--accent-amber)`:`none`,color:e<=r?`var(--accent-amber)`:`var(--text-muted)`},e))}),i&&(0,M.jsxs)(`span`,{className:`feedback-card-date`,children:[(0,M.jsx)(cr,{size:11}),(0,M.jsx)(`span`,{children:ee(i)})]})]}),(0,M.jsxs)(`p`,{className:`feedback-card-text`,children:[`"`,n,`"`]}),(0,M.jsxs)(`div`,{className:`feedback-card-author`,children:[(0,M.jsx)(Hr,{size:13}),(0,M.jsxs)(`span`,{children:[`Gamer #`,e.Id||e.id||t+1]})]})]},e.Id||e.id||t)})})]}),(0,M.jsx)(`style`,{children:`
        .feedback-page-root {
          display: flex;
          flex-direction: column;
          align-items: center;
      ...
      `})]})},xi=()=>{let{t:e}=Xn();return(0,M.jsxs)(`div`,{className:`not-found-container`,children:[(0,M.jsx)(`div`,{className:`not-found-code heading-display`,children:`404`}),(0,M.jsx)(`h1`,{className:`not-found-title heading-display`,children:e(`not_found_title`)}),(0,M.jsx)(`p`,{className:`not-found-desc`,children:e(`not_found_desc`)}),(0,M.jsxs)(Mn,{to:`/`,className:`btn btn-primary not-found-btn`,children:[(0,M.jsx)(yr,{size:18}),(0,M.jsx)(`span`,{children:e(`back_home`)})]}),(0,M.jsx)(`style`,{children:`
        .not-found-container {
          display: flex;
          flex-direction: column;
          align-items: center;
      ...
      `})]})};Kn.createRoot(document.getElementById(`root`)).render((0,M.jsx)(x.StrictMode,{children:(0,M.jsx)(jn,{children:(0,M.jsx)(Yn,{children:(0,M.jsx)(()=>{let[e,t]=(0,x.useState)(!1),n=_t();return(0,M.jsxs)(`div`,{className:`app-layout`,children:[(0,M.jsx)(Jr,{}),(0,M.jsx)(Gr,{onOpenAbout:()=>t(!0)}),(0,M.jsx)(`main`,{className:`main-content`,children:(0,M.jsx)(Yr,{children:(0,M.jsxs)(Wt,{location:n,children:[(0,M.jsx)(Ht,{path:`/`,element:(0,M.jsx)(_i,{})}),(0,M.jsx)(Ht,{path:`/series`,element:(0,M.jsx)(vi,{})}),(0,M.jsx)(Ht,{path:`/library`,element:(0,M.jsx)(yi,{})}),(0,M.jsx)(Ht,{path:`/feedback`,element:(0,M.jsx)(bi,{})}),(0,M.jsx)(Ht,{path:`*`,element:(0,M.jsx)(xi,{})})]})},n.pathname)}),(0,M.jsx)(qr,{isOpen:e,onClose:()=>t(!1)})]})},{})})})}));